...
CK_CA_InitSlotRolePIN = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_SLOT_ID, CK_USER_TYPE, CK_CHAR_PTR, CK_ULONG)
...
CK_CA_GetTokenCapabilities = CFUNCTYPE(CK_RV, CK_SLOT_ID, CK_ULONG_PTR, CK_ULONG_PTR, CK_ULONG_PTR, CK_ULONG_PTR)
CK_CA_SetTokenPolicies = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_SLOT_ID, CK_ULONG, CK_ULONG_PTR, CK_ULONG_PTR)
CK_CA_GetTokenPolicies = CFUNCTYPE(CK_RV, CK_SLOT_ID, CK_ULONG_PTR, CK_ULONG_PTR, CK_ULONG_PTR, CK_ULONG_PTR)
...
CK_CA_OpenSecureToken = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_ULONG, CK_ULONG, CK_ULONG, CK_ULONG_PTR, CK_ULONG_PTR)
CK_CA_CloseSecureToken = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_ULONG)
CK_CA_ListSecureToken = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_ULONG, CK_BYTE_PTR, CK_ULONG_PTR)
class CK_MECHANISM(Structure):
    pass
CK_MECHANISM_PTR = POINTER(CK_MECHANISM)
CK_CA_GetSecureElementMeta = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_ULONG, CK_MECHANISM_PTR, CK_ULONG_PTR, CK_ULONG_PTR, CK_BYTE_PTR, CK_ULONG)
...
CK_CA_GetTokenObjectHandle = CFUNCTYPE(CK_RV, CK_SLOT_ID, POINTER(CK_BYTE), CK_ULONG_PTR, CK_ULONG_PTR)
...
CK_CA_GetTokenStorageInformation = CFUNCTYPE(CK_RV, CK_SLOT_ID, CK_ULONG_PTR, CK_ULONG_PTR, CK_ULONG_PTR, CK_ULONG_PTR, CK_ULONG_PTR)
...
CK_CA_GetUnauthTokenInsertionStatus = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_ULONG, POINTER(CK_ULONG), POINTER(CK_ULONG))
CK_CA_DisableUnauthTokenInsertion = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_ULONG)
CK_CA_STCRegister = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_SLOT_ID, POINTER(CK_CHAR), CK_ULONG, POINTER(CK_CHAR), CK_ULONG, POINTER(CK_CHAR), CK_ULONG)
CK_CA_STCDeregister = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_SLOT_ID, POINTER(CK_CHAR))
CK_CA_STCGetPubKey = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_SLOT_ID, POINTER(CK_CHAR), POINTER(CK_CHAR), CK_ULONG_PTR, POINTER(CK_CHAR), CK_ULONG_PTR)
CK_CA_STCGetClientsList = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_SLOT_ID, CK_ULONG_PTR, CK_ULONG_PTR)
CK_CA_STCGetClientInfo = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_SLOT_ID, CK_ULONG, POINTER(CK_CHAR), CK_ULONG_PTR, CK_ULONG_PTR, POINTER(CK_CHAR), CK_ULONG_PTR, POINTER(CK_CHAR), CK_ULONG_PTR)
CK_CA_STCGetPartPubKey = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_SLOT_ID, POINTER(CK_CHAR), CK_ULONG_PTR, POINTER(CK_CHAR), CK_ULONG_PTR)
CK_CA_STCGetAdminPubKey = CFUNCTYPE(CK_RV, CK_SLOT_ID, POINTER(CK_CHAR), CK_ULONG_PTR, POINTER(CK_CHAR), CK_ULONG_PTR)
if 'win' in sys.platform:
...
CK_SFNT_CA_FUNCTION_LIST._fields_ = [
    ...
    ('CA_ListSecureToken', CK_CA_ListSecureToken),
...
CA_OpenSecureToken.argtypes = [CK_SESSION_HANDLE, CK_ULONG, CK_ULONG, CK_ULONG, CK_ULONG_PTR, CK_ULONG_PTR]
...
CA_ListSecureToken = make_late_binding_function('CA_ListSecureToken')
CA_ListSecureToken.restype = CK_RV
CA_ListSecureToken.argtypes = [CK_SESSION_HANDLE, CK_ULONG, CK_BYTE_PTR, CK_ULONG_PTR]
CA_GetSecureElementMeta = make_late_binding_function('CA_GetSecureElementMeta')
CA_GetSecureElementMeta.restype = CK_RV
CA_GetSecureElementMeta.argtypes = [CK_SESSION_HANDLE, CK_ULONG, CK_MECHANISM_PTR, CK_ULONG_PTR, CK_ULONG_PTR, CK_BYTE_PTR, CK_ULONG]
...
HANDLE = c_int
__all__ = ['RC_MANUFACTURING_NO_CONFIG_AVAILABLE',
           'CK_ECMQV_DERIVE_PARAMS_PTR',
           'LUNA_RET_HIFN_COMPRESSION_HEADER_COUNT_INVALID',
           'CA_InvokeService', 'CK_VERSION_PTR',
           ...
           'CK_CA_HAAnswerMofNChallenge', 'LUNA_RET_CB_TIMEOUT',
           'CK_X9_42_DH2_DERIVE_PARAMS_PTR', 'ResultCodeValue',
           'LUNA_RET_WRAPPING_KEY_SIZE_RANGE', 'LUNA_RET_BAD_DAC',
           'CK_KEA_DERIVE_PARAMS_PTR',
           'CK_CA_DisableUnauthTokenInsertion',
           'RC_SSL_CREATE_SSL_ERROR', 'C_UnwrapKey', 'BYTE',
           'LUNA_RET_BAD_DAK', 'CK_CA_GetRemotePEDVectorStatus',
           'CA_PerformModuleCall',
           'LUNA_RET_HIFN_ENCRYPT_HEADER_COUNT_INVALID',
           'LUNA_HIFN_UNKNOWN_ALGORITHM', 'LUNA_RET_HA_NOT_SUPPORTED',
           'CK_CA_STCGetAdminPubKey', 'CA_OpenSession',
           'LUNA_RET_VECTOR_OF_DIFFERENT_SET', 'CA_MTKZeroize',
           'RC_NO_BUFFER', 'CK_LKM_TOKEN_ID_PTR',
           'RC_USER_NAME_IN_USE', 'CA_SetContainerPolicy',
           'CK_WTLS_PRF_PARAMS_PTR', 'C_FindObjectsFinal',
           'CA_SetPedId', 'CK_C_CancelFunction',
           'LUNA_RET_ECC_NOT_SUPPORTED', 'CK_CA_FactoryReset',
           'MSG_GENERATING_NEW_TVK_FAILED', 'CK_C_GetSessionInfo',
           'CK_C_VerifyRecover', 'CK_C_EncryptFinal',
           'RC_UNABLE_TO_CONNECT', 'CK_CA_ModifyMofN',
           'C_SetAttributeValue',
           'RC_SSL_CERT_VERIFICATION_LOCATION_ERROR',
           'CK_RC2_CBC_PARAMS_PTR',
           'LUNA_RET_SECRET_KEY_MUST_HAVE_SENSITIVE_ATTRIBUTE',
           'CA_ManualKCV', 'LUNA_RET_SM_ACCESS_ID_INVALID',
           'LUNA_RET_CL_QUEUE_LOCATION_ERROR',
           'RC_SSL_INVALID_CERT_STRUCTURE', 'CK_RSA_PKCS_OAEP_PARAMS',
           'LUNA_RET_SM_ACCESS_DOES_NOT_VALIDATE',
           'LUNA_RET_HA_USER_NOT_INITIALIZED',
           'LUNA_RET_MD5_SELF_TEST_FAILURE',
           'LUNA_RET_OPERATION_NOT_INITIALIZED', 'CA_Deactivate',
           'LUNA_RET_LOG_BAD_TIME', 'CA_GetHSMCapabilitySetting',
           'LUNA_RET_SM_CONTEXT_NOT_ALLOCATED', 'LUNA_RET_CB_ABORTED',
           'MSG_NVRAM_READ_FAILED',
           'CK_CA_CloseApplicationIDForContainer',
           'CA_EncodeECPrimeParams', 'RC_FILE_READ_ONLY',
           'LUNA_RET_HOK_MISSING', 'RC_USB_PED_OUT_OF_SYNC',
           'CK_CA_GetContainerCapabilitySet',
           'LUNA_RET_WEIGHT_TOO_SMALL',
           'LUNA_RET_HIFN_COMPRESS_SOURCE_NOT_ZERO',
           'CK_SSL3_KEY_MAT_PARAMS_PTR', 'CK_DATE', 'C_CloseSession',
           'LUNA_RET_TEMPLATE_INCONSISTENT',
           'RC_NON_CRYPTOKI_ELEMENT_CLONE',
           'CA_GetConfigurationElementDescription',
           'LUNA_RET_PED_UNPLUGGED', 'CK_WTLS_PRF_PARAMS',
           'CK_RC2_MAC_GENERAL_PARAMS',
           'LUNA_RET_HIFN6500_RNG_TIMEOUT',
           'LUNA_RET_VECTOR_TOO_LARGE',
           'MSG_INITIALIZING_MSG_TVK_TIMESTAMP_FAILED',
           'LUNA_RET_KCV_PARAMETER_MISSING', 'CA_GetMofNStatus',
           'LUNA_RET_KEY_INDIGESTIBLE', 'LUNA_RET_HSM_STORAGE_FULL',
           'CK_SLOT_INFO', 'CA_ConfigureRemotePED', 'CA_GetTPV',
           'LUNA_RET_PED_ID_INVALID', 'CK_C_EncryptInit',
           ...
           'LUNA_RET_TOKEN_LOCKED_OUT_STC', 'CK_C_SetPIN',
           'CA_QueryLicense', 'CK_C_INITIALIZE_ARGS',
           'LUNA_RET_M_OF_N_ACTIVATION_REQUIRED', 'C_Logout',
           ...
           'RC_SSL_LOAD_SERVER_PRIVATE_KEY_ERROR', 'CK_ATTRIBUTE_PTR',
           'CK_VERSION', 'CK_C_GetOperationState', 'fwResultCode',
           'RC_DATA_CORRUPTED', 'LUNA_RET_KEY_UNEXTRACTABLE',
           'RC_USB_PED_NOT_FOUND', 'CK_CA_GetFPV',
           'CK_SESSION_HANDLE_PTR', 'Int32',
           'LUNA_RET_CL_QUEUE_OVERLAP_ERROR', 'LUNA_RET_BAD_SN',
           'CA_GetTokenInsertionCount', 'CK_CA_InitRolePIN',
           'CK_MECHANISM_PTR', 'LUNA_RET_CB_HIOS_RECV_TIMEOUT',
           'CK_ECDH2_DERIVE_PARAMS_PTR', 'CK_RC5_CBC_PARAMS',
           'C_WaitForSlotEvent', 'CK_C_CloseSession',
           'CA_LKMInitiatorComplete', 'CA_CloneAsTargetInit',
           'CK_WTLS_KEY_MAT_OUT', 'CA_GetContainerList',
           'LUNA_RET_TOKEN_LOCKED_OUT_CCM', 'MSG_NVRAM_WRITE_FAILED',
           'LUNA_RET_M_OF_N_PARAMETER_EXIST',
           'CK_CAMELLIA_CBC_ENCRYPT_DATA_PARAMS', 'UInt64',
           'LUNA_RET_TOKEN_LOCKED_OUT_MM',
           'LUNA_RET_RC2_SELF_TEST_FAILURE', 'CK_VOID_PTR',
           'CK_C_Sign', 'CK_CA_GetTunnelSlotNumber',
           'CA_HAGetLoginChallenge', 'CA_EncodeECChar2Params',
           'LUNA_RET_MTK_ZEROIZED', 'CK_CA_ReadCommonStore',
           'LUNA_RET_ECC_UNKNOWN_CURVE', 'RC_SSL_WANT_READ_ERROR',
           'LUNA_RET_CCM_UPDATE_DENIED',
           'LUNA_RET_410_CHALLENGE_RESPONSE_INCORRECT',
           'LUNA_RET_GENERAL_ERROR', 'SInt32',
           'MSG_TVK_TIMESTAMP_RECOVERY_FAILED', 'CKCA_MODULE_ID_PTR',
           'LUNA_RET_SM_ACCESS_ALREADY_EXISTS', 'CK_LONG',
           'CA_Extract', 'CA_MOFN_GENERATION', 'RC_FILE_LOCK_ERROR',
           'CA_GetTokenCertificateInfo',
           'LUNA_RET_LICENSE_CAPACITY_EXCEEDED',
           'LUNA_RET_RM_POLICY_ELEMENT_NOT_DESTRUCTIVE', 'C_Decrypt',
           'MSG_TVK_TIMESTAMP_UPDATE_WAS_LIKELY_ABORTED_TRYING_TO_RECOVER',
           'LUNA_RET_INVALID_PADDING_TYPE', 'CK_C_VerifyInit',
           'CK_CA_ResetPIN', 'CK_C_SignEncryptUpdate',
           'CK_C_Initialize', 'MSG_RTC_LOST_ALL_POWER',
           'LUNA_RET_WRAPPING_KEY_TYPE_INCONSISTENT',
           'CK_SFNT_CA_FUNCTION_LIST_PTR', 'RC_SSL_SYSCALL_ERROR',
           'RC_CACHE_DIRTY', 'CK_SKIPJACK_PRIVATE_WRAP_PTR',
           'LUNA_RET_HIFN6500_INVALID_OPERAND_LENGTH',
           'CK_MAC_GENERAL_PARAMS_PTR', 'CK_EXTRACT_PARAMS_PTR',
           'LUNA_RET_RM_CONFIG_ILLEGAL', 'CA_LoadModule',
           'LUNA_RET_ECC_DAK_MISSING', 'LUNA_RET_BAD_MAC',
           'LUNA_RET_RM_NO_MEMORY', 'RC_GROUP_NAME_INVALID',
           'CK_PKCS5_PBKDF2_SALT_SOURCE_TYPE_PTR', 'CA_LogGetConfig',
           'LUNA_RET_CB_RETRY', 'LUNA_RET_MM_INVALID_USAGE',
           'CK_CA_GetObjectUID', 'MSG_RESTART',
           'CK_OBJECT_HANDLE_PTR', 'LUNA_RET_ISES_RNG_TEST_FAILED',
           'CK_ECDH1_DERIVE_PARAMS',
           'MSG_RTC_RTC_MONITOR_CANT_COMMUNICATE_TO_RTC',
           'RC_FILE_NAME_INVALID', 'LUNA_RET_BUFFER_TOO_SMALL',
           'CK_CA_SIMExtract', 'C_DecryptDigestUpdate',
           'CK_WTLS_MASTER_KEY_DERIVE_PARAMS', 'C_EncryptUpdate',
           'CK_CA_LogExportSecret', 'C_SetOperationState',
           'LUNA_RET_MISSING_VALUE_FOR_M',
           'LUNA_RET_MISSING_VALUE_FOR_N', 'CK_CA_InvokeServiceFinal',
           'CK_AES_GCM_PARAMS', 'CK_CA_ConfigureRemotePED',
           'LUNA_RET_CL_TRANSMISSION_ERROR',
           'LUNA_RET_OBJECT_HANDLE_INVALID',
           'CA_HAAnswerLoginChallenge', 'CK_FLAGS',
           'CK_CA_MultisignValue', 'CA_SetHSMPolicies',
           'RC_FAILED_TO_CREATE_THREAD', 'LUNA_RET_KEY_NOT_ACTIVE',
           'HANDLE', 'CK_CA_STCDeregister', 'CA_UnloadModule',
           'LUNA_RET_DATA_INVALID', 'CK_XOR_BASE_DATA_KDF_PARAMS_PTR',
           'Float64', 'CK_CA_GetContainerStatus', 'CA_HAActivateMofN',
           'LUNA_RET_PED_DEK_INVALID', 'CK_CA_HAInit', 'Int',
           'CA_LKMReceiverResponse', 'LUNA_RET_LOG_RESYNC_NEEDED',
           'CK_CA_SpRawWrite', 'CK_XOR_BASE_DATA_KDF_PARAMS',
           'LUNA_RET_TUK_PARAMETER_MISSING', 'CK_OTP_PARAM_PTR',
           'CK_C_InitPIN', 'RC_SOCKET_ERROR', 'CK_RC2_PARAMS_PTR',
           'LUNA_RET_HIFN6500_RESET_TIMEOUT',
           'CA_GetNumberOfAllowedContainers', 'LUNA_RET_N_TOO_LARGE',
           'RC_SSL_WANT_WRITE_ERROR', 'CK_CA_GetHAState',
           'CK_CA_InitAudit', 'C_CloseAllSessions',
           'LUNA_RET_KEY_PARITY', 'RC_SSL_GET_CERTIFICATE_ERROR',
           'CA_InitAudit', 'CK_OTP_PARAMS_PTR', 'CA_M_OF_N_STATUS',
           'C_SignUpdate', 'CK_SKIPJACK_RELAYX_PARAMS_PTR',
           'LUNA_RET_STATE_UNSAVEABLE', 'CK_C_VerifyRecoverInit',
           'LUNA_RET_MAC_MISSING', 'C_VerifyRecover',
           'CA_GetModuleInfo',
           'LUNA_RET_HIFN_MAC_HEADER_COUNT_INVALID',
           'CK_TLS_PRF_PARAMS', 'LUNA_RET_OPERATION_RESTRICTED',
           'PointerDifference', 'LUNA_RET_SM_UNKNOWN_ACCESS_TYPE',
           'MSG_RTC_CANT_INITIALIZE_I2C',
           'LUNA_RET_CB_HIOS_OUTPUT_BUFFER_TOO_SMALL',
           'CK_SSL3_RANDOM_DATA',
           'LUNA_RET_STORAGE_TYPE_INCONSISTENT', 'CK_C_GetInfo',
           'C_InitPIN', 'CK_C_Login', 'CK_WTLS_KEY_MAT_PARAMS',
           'CK_AES_CBC_ENCRYPT_DATA_PARAMS_PTR',
           'CK_CA_GetExtendedTPV', 'CA_GetObjectHandle',
           'CK_C_Decrypt', 'CA_GetRemotePEDVectorStatus',
           'CK_C_GetFunctionList',
           'LUNA_RET_UNWRAPPING_KEY_SIZE_RANGE',
           'LUNA_RET_TOKEN_LOCKED_OUT_PM', 'LUNA_RET_HIFN_DMA_ERROR',
           'LUNA_RET_CANCEL', 'LUNA_RET_RNG_SELF_TEST_FAILURE',
           'CK_CA_TokenDelete', 'CK_SLOT_ID', 'CK_CA_LogGetStatus',
           'CK_CA_FindAdminSlotForSlot', 'CA_CapabilityUpdate',
           'CA_GetExtendedTPV', 'CK_C_DigestEncryptUpdate',
           'CK_CA_IsMofNRequired', 'CA_FirmwareUpdate',
           'RC_CERT_TYPE_INVALID', 'C_VerifyRecoverInit',
           'LUNA_RET_PED_CLIENT_NOT_RUNNING',
           'LUNA_RET_HIFN6500_RNG_UNDERFLOW', 'RC_OBJECT_NOT_IN_LIST',
           'CK_HA_MEMBER_PTR', 'CA_SetApplicationID',
           ...
           'LUNA_RET_MM_INVALID_HANDLE', 'CK_CA_LogExternal',
           'SInt16', 'CA_IndirectLogin',
           'LUNA_RET_SFNT3120_ALG_NO_SOFTWARE_SUPPORT',
           'LUNA_RET_INVALID_PRIVATE_KEY_TYPE', 'CA_SIMExtract',
           'CK_CA_CloseSecureToken', 'CK_SKIPJACK_RELAYX_PARAMS',
           'CA_SetDestructiveHSMPolicy', 'CK_C_FindObjectsInit',
           'CA_OpenSecureToken',
           'LUNA_RET_WRAPPING_KEY_HANDLE_INVALID',
           'LUNA_RET_SM_UNKNOWN_COMMAND',
           'CK_RSA_PKCS_OAEP_SOURCE_TYPE', 'CK_UNLOCKMUTEX',
           'CK_CA_GetNumberOfAllowedContainers', 'CK_OTP_PARAM',
           'LUNA_RET_INVALID_FUF_TARGET', 'LUNA_RET_ARGUMENTS_BAD',
           'C_DigestEncryptUpdate',
           'RC_MANUFACTURING_TOKEN_NOT_PRESENT', 'RC_SLOT_ID_INVALID',
           'CK_CA_MTKResplit', 'LUNA_INVALID_PACKET_LAYOUT',
           'CK_OTP_PARAMS', 'SInt8', 'CK_CA_GetFunctionList',
           'LastFirmwareCode', 'LUNA_RET_MD2_SELF_TEST_FAILURE',
           'RC_PARTITION_LOCKED', 'CA_GetSecureElementMeta',
           'CK_CA_CloneAsTarget', 'CK_CA_RetrieveLicenseList',
           'CK_CA_HALogin', 'LUNA_RET_NOT_FOUND',
           'CK_C_SetOperationState',
           'MSG_RTC_CONFIGURATION_CORRUPTED',
           'CK_CA_InvokeServiceInit', 'LUNA_RET_SAVED_STATE_INVALID',
           'CA_CloneAsSource', 'CK_ECMQV_DERIVE_PARAMS',
           'CK_CA_LKMReceiverComplete', 'CA_InvokeServiceSinglePart',
           'CK_KDF_PRF_ENCODING_SCHEME', 'LUNA_RET_MAX_OBJECT_COUNT',
           'CA_MOFN_ACTIVATION_PTR',
           'MSG_RTC_CANT_ARM_TAMPER_1_CIRCUITS',
           'LUNA_RET_M_TOO_LARGE', 'UInt16',
           'LUNA_RET_CB_HIOS_HANDLE_INVALID', 'RC_PIN_INVALID',
           'CK_CA_SetHSMPolicy', 'RC_SOCKET_CLOSED',
           'CK_CA_LockClusteredSlot', 'RC_ENDOFLIST', 'UInt32',
           'LUNA_RET_LOG_NO_KCV', 'CK_C_DecryptInit',
           'LUNA_RET_DAC_POLICY_PID_MISMATCH', 'CK_CA_GetTokenStatus',
           'LUNA2_RET_HIFN_RESET_ERROR', 'RC_UNEXPECTED',
           'LUNA_RET_HIFN6500_ALU_TIMEOUT', 'CK_C_InitToken',
           'CA_InvokeServiceFinal', 'CK_CA_EncodeECParamsFromFile',
           'CA_LockClusteredSlot', 'LUNA_RET_SM_NOT_LOGGED_IN',
           'CK_CA_SIMInsert', 'CK_CA_RestartForContainer',
           'LUNA_RET_MISSING_COMMAND_PARAMETER',
           'LUNA_RET_KEY_EXTRACTABLE',
           'LUNA_RET_SHA1_RSA_SELF_TEST_FAILURE', 'CA_FactoryReset',
           'CA_LoadEncryptedModule', 'CA_SetUserContainerName',
           'CK_TLS_PRF_PARAMS_PTR',
           'MSG_RTC_MSG_NVRAM_ZAPPING_FAILED',
           'CK_CA_InsertMaskedObject', 'RC_MEMORY_ALLOCATION',
           'CK_CA_OpenSecureToken', 'LUNA_RET_SM_PIN_EXPIRED',
           'C_VerifyFinal', 'C_DeriveKey', 'C_OpenSession',
           'CK_CA_SetUserContainerName', 'RC_OBJECT_ALREADY_EXISTS',
           'LUNA_RET_SM_SESSION_REALLOC_ERROR',
           'MSG_ZEROIZING_AFTER_DECOMMISSION', 'CA_MOFN_ACTIVATION',
           'MSG_GENERATING_NEW_TVK_PASSED', 'C_Sign',
           'LUNA_RET_HIFN_INVALID_MAC_ALGORITHM',
           'CA_WaitForSlotEvent', 'CA_ChoosePrimarySlot',
           'CK_TOKEN_INFO', 'RC_BUFFER_TOO_SMALL',
           'RC_CLIENT_DISCONNECTED', 'CK_ECDH1_DERIVE_PARAMS_PTR',
           'LUNA_RET_INVALID_BOARD_TYPE', 'LUNA_RET_UNWRAPPING_ERROR',
           'RC_SERVER_DISCONNECTED', 'LUNA_RET_CB_PROT_DATA_INVALID',
           'LUNA_RET_LICENSE_ID_UNKNOWN',
           'LUNA_RET_KCDSA_PARAM_GEN_FAILURE',
           'CK_C_CloseAllSessions', 'LUNA_RET_CL_ALIGNMENT_ERROR',
           'LUNA_RET_HIFN_DMA_INVALID_REVISION',
           'LUNA_RET_TOKEN_NOT_PRESENT', 'CK_VOID_PTR_PTR',
           'CK_RSA_PKCS_PSS_PARAMS_PTR', 'CK_USER_TYPE',
           'C_DigestUpdate', 'C_GetMechanismList', 'CA_ResetDevice',
           'CK_C_DigestFinal', 'LUNA_RET_HIFN_MAC_SOURCE_NOT_ZERO',
           'LUNA_RET_SM_BAD_CONTEXT_NUMBER', 'RC_OPERATION_TIMED_OUT',
           'LUNA_RET_CL_COMMAND_MALFORMED', 'LUNA_RET_SFNT3120_ERROR',
           'LUNA_RET_LOG_BAD_RECORD_HMAC', 'CKCA_MODULE_ID',
           'LUNA_RET_MECHANISM_PARAM_INVALID',
           'LUNA_RET_SIM_VERSION_UNSUPPORTED', 'CK_CA_LoadModule',
           'LUNA_RET_CAN_NOT_CHANGE_KEY_FUNCTION',
           'RC_UNKNOWN_COMMAND_VERSION', 'RC_CLIENT_MESSAGE_ERROR',
           'LUNA_RET_M_OF_N_PARAMETER_NOT_AVAILABLE',
           'CK_ARIA_CTR_PARAMS', 'C_GetAttributeValue',
           'CK_CA_GetTime', 'MSG_ZEROIZING_AFTER_NO_SECURE_DATA',
           'CA_OpenApplicationID', 'LUNA_RET_TEMPLATE_INCOMPLETE',
           'LUNA_RET_CB_MUST_READ', 'LUNA_RET_WRAPPING_ERROR',
           'LUNA_RET_CCM_NOT_PRESENT', 'CA_ReadCommonStore',
           'CK_CA_GenerateCloningKEV', 'MSG_RTC_CANT_ACCESS',
           'CA_SwitchSecondarySlot', 'CK_CAMELLIA_CTR_PARAMS',
           'eInitMsgs', 'LUNA_RET_RETRY',
           'LUNA_RET_AUDIT_LOGIN_TIMEOUT_IN_PROGRESS',
           'CA_LogVerifyFile',
           'RC_SSL_VALIDATE_SERVER_PRIVATE_KEY_ERROR', 'CA_Restart',
           'CK_HA_MEMBER', 'CK_EC_ENC_SCHEME',
           'CK_C_INITIALIZE_ARGS_PTR', 'CK_CA_SetLKCV',
           'LUNA_RET_CB_HIOS_CANCELED', 'CK_MECHANISM_INFO_PTR',
           'CA_DuplicateMofN', 'CK_CA_GetModuleList',
           'LUNA_RET_CB_REMOTE_ABORT', 'CK_MAC_GENERAL_PARAMS',
           'LUNA_RET_TOKEN_LOCKED_OUT_SM', 'LUNA_RET_OK',
           'CK_AES_CBC_PAD_INSERT_PARAMS_PTR', 'C_GetFunctionStatus',
           'CK_CA_PerformModuleCall', 'CA_GetClusterState',
           'LUNA_RET_SIGNATURE_LEN_RANGE', 'CK_C_SignRecoverInit',
           'MSG_RTC_UNRELIABLE_DUE_TO_LOW_BATTERY_WHEN_MAIN_POWER_WAS_OFF',
           'C_GenerateKey', 'RC_DER_CLASS_INVALID',
           'CK_CA_SetExtendedTPV', 'CA_RetrieveLicenseList',
           'CK_CA_CloseSecondarySession', 'CK_CA_ResetDevice',
           'CA_DismantleRemotePED', 'CK_CA_FirmwareUpdate',
           'LUNA_RET_CB_HANDLE_INVALID', 'CA_ResetPIN',
           'CK_CA_GetHSMPolicySet', 'CK_CA_MTKRestore',
           'CK_OBJECT_CLASS', 'CK_SSL3_MASTER_KEY_DERIVE_PARAMS',
           'CK_UTF8CHAR_PTR', 'CK_WTLS_KEY_MAT_OUT_PTR',
           'LUNA_RET_CONTAINER_LOCKED',
           'MSG_TVK_WAS_LOST_DUE_TO_DECOMMISSIONING',
           'CK_AES_GMAC_PARAMS', 'CK_OBJECT_HANDLE',
           'LUNA_RET_NOT_READY', 'CK_PBE_PARAMS_PTR',
           'LUNA_RET_ISES_TEST_VS_BSAFE_FAILED', 'C_SeedRandom',
           'swapper', 'CK_X9_42_DH_KDF_TYPE', 'Word',
           'LUNA_RET_SM_TSV_MISSING', 'C_WrapKey',
           'LUNA_RET_TOKEN_LOCKED_OUT', 'CK_CA_FirmwareRollback',
           'RC_GENERAL_ERROR', 'CA_RestartForContainer', 'Boolean',
           'LUNA_RET_KEY_HANDLE_INVALID', 'LUNA_RET_RNG_ERROR',
           'RC_OPERATION_WOULD_BLOCK', 'CK_DES_CTR_PARAMS',
           'C_PerformSelfTest', 'CK_CA_GetTokenCertificates',
           'RC_PARTITION_NOT_ACTIVATED', 'CK_CA_CapabilityUpdate',
           'LUNA_RET_CB_INVALID_CALL_FOR_THE_STATE',
           'CK_ATTRIBUTE_TYPE', 'LUNA_RET_CB_HIOS_ID_INVALID',
           'CA_CloneMofN', 'CA_MTKGetState', 'CK_C_Verify',
           'CK_SESSION_HANDLE', 'CK_CA_GetMofNStatus',
           'CK_CA_GetRollbackFirmwareVersion',
           'CK_CA_WriteCommonStore', 'CA_GetPedId',
           'CK_OTP_PARAM_TYPE', 'LUNA_RET_VECTOR_DUPLICATE',
           'LUNA_RET_PE1746_ERROR', 'CA_InitIndirectToken',
           'CK_CA_GetContainerCapabilitySetting', 'CK_C_GetSlotInfo',
           'CK_CA_TokenInsert', 'CK_CA_GenerateMofN',
           'RC_SESSION_SCRIPT_EXISTS', 'CK_CA_GetPrimarySlot',
           'LUNA_RET_CITS_DAK_MISSING',
           'CA_SetDestructiveHSMPolicies',
           'LUNA_RET_RM_POLICY_ELEMENT_DESTRUCTIVE',
           'LUNA_RET_UNKNOWN_COMMAND', 'CA_LogExternal',
           'CA_ClonePrivateKey', 'CK_AES_CBC_PAD_INSERT_PARAMS',
           'CK_EC_MAC_SCHEME', 'CK_C_GetMechanismInfo',
           'CK_MECHANISM_TYPE_PTR', 'CK_CA_GetTokenCertificateInfo',
           'LUNA_RET_TSN_MISMATCH', 'RC_FILE_LOCK_FAILED',
           'LUNA_RET_SP_RX_ERROR', 'RC_UNKNOWN_COMMAND',
           'C_CancelFunction', 'CK_HA_STATUS',
           'CK_CA_STCGetClientInfo', 'MSG_RTC_ZEROIZED_ON_POWER_LOSS',
           'LUNA_RET_CONTAINER_IS_DISABLED',
           'RC_LISTEN_SOCKET_INVALID', 'LUNA_RET_ECC_DAC_MISSING',
           'CK_C_DigestKey', 'C_GetInfo', 'C_Initialize',
           'RC_INVALID_COMMAND', 'C_DestroyObject',
           'C_GetOperationState', 'LUNA_RET_TOO_MANY_CONTAINERS',
           'LUNA_RET_ROOT_CERT_MISSING',
           'LUNA_RET_UM_PIN_INCORRECT_CONTAINER_ZEROIZED',
           'LUNA_RET_WRAPPED_KEY_INVALID', 'CA_DeleteContainer',
           'CA_GetContainerPolicySetting', 'C_InitToken',
           'CK_C_WrapKey', 'LUNA_RET_SIGNING_KEY_MUST_BE_LOCAL',
           ...
           'LUNA_RET_CCM_SIGN_INVALID', 'C_Login', 'C_GetSlotInfo',
           'CK_CA_InitIndirectPIN', 'CA_DeleteRemotePEDVector',
           'CK_CA_CloneAllObjectsToSession',
           'CK_CA_UnlockClusteredSlot', 'CK_CA_GetTokenCapabilities',
           ...
           'LUNA_RET_INVALID_CERTIFICATE_VERSION', 'CK_ULONG',
           'CK_SSL3_KEY_MAT_OUT_PTR', 'C_GetMechanismInfo',
           'CK_C_GenerateRandom', 'CK_CA_ActivateMofN',
           'CK_WTLS_RANDOM_DATA', 'CA_MTKResplit', 'CK_CHAR',
           'CA_HALogin', 'CA_GetHSMStats', 'LUNA_RET_BAD_PPID',
           'CK_STATE', 'UInt8', 'CK_CA_GetHSMCapabilitySetting',
           'CK_KEY_WRAP_SET_OAEP_PARAMS',
           'LUNA_RET_USER_TYPE_INVALID',
           'LUNA_RET_VECTOR_VERSION_INVALID', 'CA_GetPrimarySlot',
           'CK_CA_GetConfigurationElementDescription',
           'LUNA_RET_MM_FATAL_ERROR', 'LUNA_RET_ATTRIBUTE_SENSITIVE',
           'LUNA_RET_HIFN_DMA_TIMED_OUT',
           'CK_CA_CloneObjectToAllSessions', 'RC_VERSION_INVALID',
           'LUNA_RET_SHA_SELF_TEST_FAILURE',
           'LUNA_RET_MISSING_WEIGHT_VALUE', 'CA_MultisignValue',
           ...
           'CK_CA_Zeroize', 'CK_ARIA_CBC_ENCRYPT_DATA_PARAMS',
           'LUNA_RET_UNWRAPPING_KEY_HANDLE_INVALID',
           'LUNA_RET_LOG_FILE_NOT_OPEN', 'CK_CA_GetContainerList',
           'CK_WTLS_KEY_MAT_PARAMS_PTR', 'LUNA_RET_ECC_HOC_MISSING',
           'LUNA_RET_KEY_NOT_UNWRAPPABLE', 'LUNA_RET_CCM_UNREMOVABLE',
           'CK_CA_InitIndirectToken', 'CA_GetTSV',
           'CA_InitIndirectPIN',
           'LUNA_RET_SM_EXCLUSIVE_SESSION_EXISTS',
           'LUNA_RET_SIM_AUTHORIZATION_FAILED', 'CK_CA_SetPedId',
           'CA_GenerateMofN', 'CK_CA_DeactivateMofN', 'C_EncryptInit',
           'C_Verify', 'CK_CA_Extract', 'LUNA_RET_SFNT3120_CRC',
           'CA_CloseApplicationIDForContainer',
           'CK_CA_GetHSMStorageInformation', 'CK_C_GenerateKeyPair',
           'RC_USB_PED_TOO_MANY_CONNECTED', 'CA_SpRawRead',
           'RC_SOCKET_READ_ERROR', 'MSG_BAD_HMAC',
           'CA_DestroyMultipleObjects', 'LUNA_RET_CCM_TOO_LARGE',
           'SInt64', 'CK_CA_GetHSMCapabilitySet', 'CK_C_SignFinal',
           'CK_CA_GetContainerPolicySet', 'RC_INVALID_CERT_HOST',
           'C_SignFinal', 'LUNA_RET_CANNOT_PERFORM_OPERATION_TWICE',
           'CA_SIMMultiSign', 'LUNA_RET_INVALID_CERTIFICATE_DATA',
           'LUNA_RET_LOG_FILE_WRITE_ERROR', 'CK_C_FindObjectsFinal',
           'CK_C_GenerateKey', 'SizeType', 'LUNA_RET_M_TOO_SMALL',
           'Byte', 'CA_UnlockClusteredSlot', 'CK_CA_CloneAsSource',
           'CK_C_GetSlotList', 'CK_FUNCTION_LIST_PTR',
           'LUNA_RET_AUDIT_LOGIN_FAILURE_THRESHOLD',
           'LUNA_RET_FORMER_INVALID_ENTRY_TYPE', 'SInt',
           'LUNA_RET_KEY_NOT_WRAPPABLE', 'RC_FILE_ERROR',
           'CK_AES_CTR_PARAMS_PTR',
           'LUNA_RET_TOKEN_LOCKED_OUT_SHA_DIGEST',
           'CK_PKCS5_PBKDF2_SALT_SOURCE_TYPE', 'CK_USHORT_PTR',
           'LUNA_RET_HIFN_INVALID_PAD_ALGORITHM',
           'CK_C_DecryptVerifyUpdate', 'CK_PKCS5_PBKD2_PARAMS_PTR',
           'C_CreateObject', 'RC_RC_ERROR',
           'LUNA_RET_OH_OBJECT_TYPE_INVALID', 'CA_ActivateMofN',
           'CK_RSA_PKCS_MGF_TYPE', 'LUNA_RET_TWC_PARAMETER_MISSING',
           'LUNA_RET_AES_SELF_TEST_FAILURE', 'CK_EXTRACT_PARAMS',
           'CKCA_MODULE_INFO', 'RC_OK',
           'LUNA_RET_OH_OBJECT_VERSION_INVALID', 'C_GetSessionInfo',
           'LUNA_RET_OH_OBJECT_OWNER_DOES_NOT_EXIST',
           'CK_SFNT_CA_FUNCTION_LIST', 'LUNA_RET_CB_REMOTE_CLOSED',
           'CK_RC5_PARAMS', 'CA_LogVerify',
           'LUNA_RET_MM_ITERATOR_PAST_END', 'CK_RC5_CBC_PARAMS_PTR',
           ...
           'RC_FAILED_TO_CREATE_PROCESS', 'CA_GetHSMCapabilitySet',
           'LUNA_RET_HOC_MISSING', 'CA_GetHSMPolicySetting',
           'LUNA_RET_LOG_BAD_FILE_NAME', 'CK_OTP_SIGNATURE_INFO_PTR',
           'LUNA_RET_CAST3_SELF_TEST_FAILURE', 'CK_SEED_CTR_PARAMS',
           'CK_CA_TokenZeroize', 'CK_ResetTotalOperations',
           'LUNA_RET_HIFN6500_INVALID_OPERAND_ENDIANESS',
           'MSG_TVK_TIMESTAMP_IS_TOO_OLD', 'CA_MOFN_GENERATION_PTR',
           ...
           'CK_LKM_TOKEN_ID', 'LUNA_RET_ECC_RESULT_AT_INF',
           'LUNA_RET_CB_HIOS_STATE_INVALID',
           'CK_CA_TokenInsertNoAuth', 'MSG_TVK_WAS_CORRUPTED',
           'CA_CloneObjectToAllSessions', 'CA_Insert',
           'CK_CA_SIMMultiSign', 'CK_CA_ChoosePrimarySlot',
           ...
           'LUNA_RET_TEST_VS_BSAFE_FAILED', 'CK_CA_GetTokenPolicies',
           'LUNA_RET_CERT_VERSION_NOT_SUPPORTED',
           'MSG_TVK_TIMESTAMP_WAS_LOST_DUE_TO_RTC_RESET',
           'CK_KIP_PARAMS', 'LUNA_RET_POLICY_NOT_FOUND',
           ...
           'LUNA_RET_SECURITY_PARAMETER_MISSING', 'MSG_LAST',
           'LUNA_RET_ENCRYPTED_DATA_INVALID', 'CK_PKCS5_PBKD2_PARAMS',
           'CK_C_Logout', 'CK_MECHANISM_TYPE',
           'CK_DES_CBC_ENCRYPT_DATA_PARAMS', 'CK_USHORT',
           'LUNA_RET_SEED_SELF_TEST_FAILURE', 'CA_SetMofN',
           'LUNA_RET_INVALID_CERTIFICATE_TYPE',
           'CK_CA_SetContainerPolicies', 'LUNA_RET_LOG_FULL',
           'CK_CLUSTER_STATE', 'LUNA_RET_MISSING_SPLITS',
           'LUNA_RET_PED_UNSUPPORTED_CRYPTO_PROTOCOL',
           'LUNA_RET_KEY_SENSITIVE',
           'MSG_RTC_EXTERNAL_TAMPER_DETECTED',
           'CA_CloseApplicationID', 'C_DecryptFinal',
           'CA_CloneModifyMofN', 'CK_CA_LoadEncryptedModule',
           'CK_LOCKMUTEX', 'LUNA_RET_HIFN6500_RNG_FAILED',
           'LUNA_RET_FLAGS_INVALID',
           'MSG_LOG_NO_SECRET_PM_LOG_INIT_IS_DEFERRED',
           'LUNA_RET_TOO_MANY_WEIGHTS', 'CK_CA_SetContainerPolicy',
           'CK_ECIES_PARAMS', 'LUNA_RET_USER_ALREADY_ACTIVATED',
           'RC_INVALID_ENUM_OPTION', 'LUNA_RET_USER_NOT_LOGGED_IN',
           'LUNA_RET_INVALID_IP_PACKET', 'CA_SetTPV', 'CK_C_Finalize',
           'LUNA_RET_CONTAINER_CAN_NOT_HAVE_MEMBERS',
           'CK_CA_RoleStateGet', 'CK_SFNT_CA_FUNCTION_LIST_PTR_PTR',
           'CK_CA_MTKSetStorage', 'CKA_SIM_AUTH_FORM',
           'CK_CA_LKMInitiatorChallenge', 'CK_CA_HAActivateMofN',
           'CK_KEY_DERIVATION_STRING_DATA',
           'LUNA_RET_COUNTER_WRAPAROUND',
           'LUNA_RET_INVALID_ENTRY_TYPE', 'CK_C_SignRecover',
           'LUNA_RET_FUNCTION_NOT_SUPPORTED_BY_HARDWARE',
           'MSG_TVK_TIMESTAMP_RECOVERY_COMPLETED',
           'CK_HW_FEATURE_TYPE', 'CA_SetTokenCertificateSignature',
           'CA_GetUserContainerName', 'RC_POINTER_INVALID',
           'RC_NOT_HSM_BACKUP_TOKEN', 'CK_C_CreateObject',
           'CK_CA_ExtractMaskedObject', 'CK_C_GetFunctionStatus',
           'CA_ROLE_STATE', 'CK_CA_UnloadModule',
           'LUNA_RET_SM_BAD_ACCESS_HANDLE',
           'MSG_RTC_CANT_ARM_TAMPER_2_CIRCUITS',
           'CK_CA_HAGetMasterPublic', 'CK_PRF_KDF_PARAMS',
           'CK_CA_Deactivate', 'CA_GetTokenCertificates',
           'LUNA_RET_ECC_POINT_INVALID', 'RC_SOCKET_ADDRESS_INVALID',
           'LUNA_RET_HIFN6500_ADDRESS_LINES_BROKEN', 'CA_MTKRestore',
           'CK_CLUSTER_STATE_PTR', 'CK_C_GetTokenInfo',
           'LUNA_RET_CB_HIOS_IO_ERROR',
           'CA_CloseAllSecondarySessions', 'CA_CheckOperationState',
           'LUNA_RET_M_OF_N_SECRET_INVALID', 'CK_RSA_PKCS_PSS_PARAMS',
           'LUNA_RET_SP_TX_ERROR', 'C_GetTokenInfo',
           'LUNA_RET_SM_UNKNOWN_TOSM_STATE', 'CK_CA_SetTokenPolicies',
           'RC_SOCKET_ADDRESS_IN_USE',
           'LUNA_RET_CL_COMMAND_NON_BACKUP', 'CK_CA_SetRDK',
           'CA_ListSecureToken', 'CK_SSL3_KEY_MAT_PARAMS',
           'RC_NOT_PARTITION_BACKUP_TOKEN',
           'LUNA_RET_RC4_SELF_TEST_FAILURE',
           'LUNA_RET_HIFN_INVALID_ENCRYPT_MODE', 'CK_CA_GetHSMStats',
           'CK_OTP_SIGNATURE_INFO',
           'LUNA_RET_M_OF_N_IS_NOT_INITIALZED',
           'LUNA_RET_CB_REMOTE_ABANDONED', 'CA_ChooseSecondarySlot',
           'LUNA_RET_HIFN_MAC_SOURCE_COUNT_INVALID',
           'RC_SEMAPHORE_ERROR', 'LUNA_RET_CB_PARAM_INVALID',
           'CA_GetFunctionList', 'CK_C_DeriveKey',
           'CA_OpenApplicationIDForContainer',
           'LUNA_RET_DSA_PARAM_GEN_FAILURE', 'CK_KEY_TYPE',
           'CK_C_DecryptFinal', 'UInt', 'CA_GetObjectUID',
           'LUNA_RET_PED_UNSUPPORTED_PROTOCOL', 'CK_CA_ManualKCV',
           'LUNA_RET_TIMEOUT', 'CK_RC2_MAC_GENERAL_PARAMS_PTR',
           'CK_CA_GetSessionInfo', 'RC_CACHE_NOT_MAPPED',
           'CK_RSA_PKCS_OAEP_SOURCE_TYPE_PTR',
           'LUNA_RET_SFNT3120_SELFTEST_FAILED',
           'LUNA_RET_TOKEN_LOCKED_OUT_OH', 'C_SignEncryptUpdate',
           'RC_SHUTTING_DOWN', 'CA_DeleteContainerWithHandle',
           ...
           'LUNA_RET_INVALID_MODULUS_SIZE', 'CK_RC5_PARAMS_PTR',
           'CK_KEA_DERIVE_PARAMS', 'CK_C_DigestInit',
           'LUNA_RET_HIFN_COMPRESSION_SOURCE_COUNT_INVALID',
           'CA_ModifyMofN', 'CA_CloneObject',
           'CK_CA_STCGetClientsList', 'C_DecryptUpdate',
           'CK_CA_STCGetPubKey', 'LUNA_RET_CHALLENGE_NOT_REQUIRED',
           'MSG_RTC_CANT_GET_TAMPER_TIMER',
           'LUNA_RET_KEY_INVALID_FOR_OPERATION', 'CK_CA_CloneObject',
           'LUNA_RET_RM_BAD_HSM_PARAMS',
           'LUNA_RET_INVALID_CERTIFICATE_FUNCTION',
           'CK_CA_GetContainerPolicySetting',
           'CK_CA_LKMReceiverResponse', 'Int64',
           'CA_InvokeServiceInit', 'LUNA_RET_SM_DATA_INVALID',
           'CA_GetTime', 'CK_TOKEN_INFO_PTR',
           'LUNA_RET_VECTOR_TYPE_INVALID', 'CK_SESSION_INFO',
           ...
           'LUNA_RET_CCM_NOT_SUPPORTED', 'CA_SetKCV',
           'CK_CA_CreateContainer',
           'LUNA_RET_ENCRYPTED_DATA_LEN_RANGE',
           'CA_ExtractMaskedObject', 'LUNA_RET_OPERATION_ACTIVE',
           'C_GenerateKeyPair', 'LUNA_RET_DAC_MISSING',
           'CK_ULONG_PTR', 'CK_C_Encrypt',
           'LUNA_RET_SIM_AUTHFORM_INVALID', 'CK_SEED_CTR_PARAMS_PTR',
           'LUNA_RET_INVALID_FUF_HEADER', 'RC_USB_PED_NOT_RESPONDING',
           'CK_KDF_PRF_PARAMS_PTR',
           'LUNA_RET_SM_CONTEXT_ALREADY_ALLOCATED',
           'LUNA_RET_RM_CONFIG_CHANGE_FAILS_DEPENDENCIES',
           'CA_GetHSMStorageInformation', 'C_DigestFinal',
           'LUNA_RET_CB_MUST_WRITE', 'CK_CA_HAAnswerLoginChallenge',
           'CA_SIMInsert', 'CK_INFO',
           'LUNA_RET_SM_OTHER_USER_LOGGED_IN',
           'LUNA_RET_HIFN6500_INVALID_RESULT_ENDIANESS',
           'LUNA_RET_ATTRIBUTE_VALUE_INVALID', 'Float32',
           'RC_TOKEN_NOT_PRESENT',
           'CK_CA_GetContainerStorageInformation',
           'CK_CA_QueryLicense',
           'LUNA_RET_HIFN_END_MARKER_NOT_PRESENT',
           'LUNA_RET_CB_HIOS_CLOSED', 'CK_ATTRIBUTE',
           'CK_CA_SetDestructiveHSMPolicies',
           'CK_RSA_PKCS_MGF_TYPE_PTR', 'CK_UTF8CHAR',
           'CK_C_DecryptDigestUpdate', 'CA_LogSetConfig',
           'CK_CA_SwitchSecondarySlot', 'RC_CANCEL', 'CK_MECHANISM',
           'CK_WTLS_RANDOM_DATA_PTR', 'LUNA_RET_UM_TSN_MISSING',
           'CA_GetContainerCapabilitySetting', 'CK_MECHANISM_INFO',
           'CK_FUNCTION_LIST',
           'LUNA_RET_HIFN_DESTINATION_COUNT_INVALID', 'C_FindObjects',
           'C_VerifyInit', 'Int16', 'CA_GetContainerStatus',
           'RC_SSL_WANT_X509_LOOKUP_ERROR', 'LUNA_RET_NO_RNG_SEED',
           'RC_SOCKET_WOULDBLOCK', 'CA_InvokeServiceAsynch',
           'CK_CA_CloneAsTargetInit',
           'LUNA_RET_RM_CONFIG_CHANGE_ILLEGAL',
           'LUNA_RET_HIFN6500_KNOWN_ANSWER_TEST_FAILED',
           'MSG_LOG_WAS_TRUNCATED', 'CK_C_WaitForSlotEvent',
           'CK_KEY_WRAP_SET_OAEP_PARAMS_PTR', 'RC_SSL_CTX_ERROR',
           'CK_C_SignUpdate', 'CK_CREATEMUTEX', 'CK_CA_LogVerify',
           'CK_CA_SetApplicationID', 'CK_CA_STCRegister',
           'CK_CA_GetTSV', 'CK_AES_CBC_ENCRYPT_DATA_PARAMS',
           'CK_ARIA_CTR_PARAMS_PTR', 'CA_IsMofNEnabled',
           'C_EncryptFinal', 'CK_KIP_PARAMS_PTR',
           'RC_OBJECT_ID_INVALID', 'C_FindObjectsInit',
           'CA_LKMReceiverComplete',
           'LUNA_RET_HIFN_INVALID_COMPRESSION_ALGORITHM',
           'CK_CA_GetUserContainerNumber', 'CK_C_SeedRandom',
           'LUNA_RET_UM_PIN_INCORRECT_CONTAINER_LOCKED',
           'LUNA_RET_CCM_FWUPDATE_DENIED', 'CK_EC_KDF_TYPE',
           'CK_CA_OpenSession', 'CA_GetSessionInfo',
           'MSG_FACTORY_RESET',
           'LUNA_RET_HIFN_INVALID_ENCRYPT_ALGORITHM',
           'LUNA_RET_HAS160_SELF_TEST_FAILURE',
           'RC_HOST_RESOLUTION_ERROR',
           'RC_USB_PED_OPERATION_CANCELLED', 'CA_GetFPV',
           'LUNA_RET_MM_USAGE_ALREADY_SET', 'CA_HAInit',
           'LUNA_RET_CCM_CERT_INVALID', 'LUNA_RET_MISSING_VECTOR',
           'CA_GetHAState', 'CK_CA_SetKCV', 'C_SignRecoverInit',
           'C_DigestInit', 'LUNA_RET_ATTRIBUTE_TYPE_INVALID',
           'LUNA_RET_CB_SYS_ERROR', 'CK_EC_DH_PRIMITIVE',
           'RC_SSL_LOAD_CLIENT_CERT_ERROR',
           'LUNA_RET_INVALID_VECTOR_SIZE', 'MSG_RTC_BATTERY_LOW',
           'CK_CA_LogGetConfig', 'LUNA_RET_TOKEN_LOCKED_OUT_RN',
           'CK_PBE_PARAMS', 'C_SignInit',
           'CK_CA_InvokeServiceSinglePart',
           'LUNA_RET_HIFN6500_NOT_PRESENT', 'ULong',
           'CK_CA_WaitForSlotEvent', 'CA_LogGetStatus',
           ...
           'CK_RSA_PKCS_OAEP_PARAMS_PTR', 'CA_HAGetMasterPublic',
           'LUNA_RET_SM_MULTIPLE_ACCESS_DISABLED',
           'LUNA_RET_CAST5_SELF_TEST_FAILURE', 'CK_SLOT_ID_PTR',
           'LUNA_RET_410_BUFFER_TOO_SMALL', 'CK_C_Digest',
           'LUNA_RET_HIFN_DESTINATION_OVERRUN',
           'MSG_RTC_IS_NOT_OPERATIONAL_AUTO_ACTIVATION_WILL_NO_WORK',
           'CK_CA_GetPedId', 'LUNA_RET_USER_ALREADY_LOGGED_IN',
           'CK_FUNCTION_LIST_PTR_PTR',
           'LUNA_RET_FUNCTION_NOT_SUPPORTED',
           'CK_CA_LKMInitiatorComplete', 'MSG_RTC_ROLLED_BACK',
           'CK_CA_DeleteRemotePEDVector',
           'MSG_RTC_HSM_WAS_REMOVED_FROM_THE_PCI_SLOT',
           'RC_SSL_FAILED_HANDSHAKE', 'CK_BYTE',
           'CK_SSL3_KEY_MAT_OUT', 'CK_C_DecryptUpdate',
           'CK_CA_LogVerifyFile', 'CK_CA_DeleteContainer',
           'CK_CA_HAGetLoginChallenge', 'CA_GenerateCloningKEV',
           'LUNA_RET_ISES_ERROR', 'LUNA_RET_ISES_LNAU_TEST_FAILED',
           'LUNA_RET_ECC_MIC_MISSING', 'CK_CA_GetTPV',
           'MSG_RTC_CANT_CLEAN_POWER_LOSS', 'CK_GetTotalOperations',
           'CK_CA_LogEraseAll', 'CK_SLOT_INFO_PTR',
           'CK_CA_GetObjectHandle', 'RC_CALLBACK_ERROR',
           'LUNA_RET_ATTRIBUTE_NOT_FOUND', 'CA_CloseSecondarySession',
           'C_Encrypt', 'CK_RV', 'RC_PORT_INVALID', 'CK_NOTIFY',
           'CK_CA_InitializeRemotePEDVector',
           'LUNA_RET_MM_NOT_ENOUGH_MEMORY', 'C_Finalize',
           'CK_C_FindObjects', 'CK_CA_SetContainerSize',
           'RC_SSL_GET_PEER_CERT_ERROR',
           'LUNA_RET_ATTRIBUTE_READ_ONLY',
           'CA_GetContainerStorageInformation',
           'CA_GetContainerPolicySet',
           'LUNA_RET_HIFN_INVALID_MAC_MODE', 'RC_SSL_ERROR',
           'LUNA_RET_DSA_SELF_TEST_FAILURE', 'CK_BYTE_PTR',
           'CA_ModifyUsageCount', 'CK_CA_TimeSync',
           'LUNA_RET_N_TOO_SMALL', 'CK_CA_GenerateTokenKeys',
           'CK_DES_CTR_PARAMS_PTR', 'CA_GetHSMPolicySet',
           'LUNA_RET_SM_KEY_SIZE_ERROR',
           'LUNA_RET_SECRET_KEY_MUST_BE_SENSITIVE', 'C_CopyObject',
           'CK_CA_CloseApplicationID', 'LUNA_RET_ECC_BUFFER_OVERFLOW',
           'LUNA_RET_OH_OBJECT_ALREADY_EXISTS', 'CK_CA_Insert',
           'CK_CA_CloseAllSecondarySessions', 'RC_DATA_INVALID',
           'C_VerifyUpdate', 'CK_NOTIFICATION',
           'LUNA_RET_KCV_PARAMETER_ALREADY_EXISTS',
           'LUNA_RET_TOKEN_LOCKED_OUT_UM', 'C_SignRecover',
           'LUNA_RET_SSK_MISSING', 'CK_C_VerifyUpdate',
           'RC_REMOTE_SIDE_DISCONNECTED', 'CK_C_GetAttributeValue',
           'CA_CreateContainer', 'CA_LogImportSecret', 'CA_TimeSync',
           'CA_LKMInitiatorChallenge', 'LUNA_RET_UM_PIN_LEN_RANGE',
           'CK_C_VerifyFinal', 'HalfWord', 'CK_C_GetMechanismList',
           'CA_CreateLoginChallenge', 'RC_PIN_LOCKED',
           'RC_SSL_LOAD_SERVER_CERT_ERROR', 'LUNA_RET_PED_ERROR',
           'LUNA_RET_MISSING_NUMBER_OF_VECTORS',
           'CA_SetContainerPolicies', 'CK_X9_42_DH_KDF_TYPE_PTR',
           'CK_ARIA_CBC_ENCRYPT_DATA_PARAMS_PTR',
           'CK_CA_EncodeECPrimeParams', 'C_DecryptVerifyUpdate',
           'CK_C_UnwrapKey', 'LUNA_RET_USER_PIN_NOT_INITIALIZED',
           'CA_MOFN_STATUS', 'CK_C_SignInit',
           'CK_CAMELLIA_CBC_ENCRYPT_DATA_PARAMS_PTR',
           'CK_CA_GetContainerName', 'CK_CA_CloneMofN',
           'LUNA_RET_DES_SELF_TEST_FAILURE', 'CK_SESSION_INFO_PTR',
           'LUNA_RET_ERROR', 'CA_GenerateTokenKeys',
           'LUNA_RET_ECC_SELF_TEST_FAILURE',
           'LUNA_RET_CHALLENGE_REQUIRES_PED', 'CK_C_CopyObject',
           'CK_CA_CreateLoginChallenge', 'CK_CERTIFICATE_TYPE',
           'MSG_ZEROIZING', 'CA_FirmwareRollback', 'Float',
           'CK_KDF_PRF_TYPE', 'LUNA_RET_CL_NO_TRANSMISSION',
           'CK_CA_DestroyMultipleObjects', 'LUNA_RET_OBJECT_DELETED',
           'CK_CA_GenerateCloneableMofN', 'RC_SIM_NOT_SUPPORTED',
           'CA_GenerateCloneableMofN', 'CK_CMS_SIG_PARAMS',
           'CK_X9_42_DH1_DERIVE_PARAMS_PTR', 'CK_CHAR_PTR',
           'CT_TokenHndle', 'LUNA_RET_MASKING_NOT_SUPPORTED',
           'C_Digest', 'CK_SSL3_MASTER_KEY_DERIVE_PARAMS_PTR',
           'MSG_RTC_MSG_NVRAM_READ_FAILED',
           'CA_HAAnswerMofNChallenge', 'C_SetPIN',
           'CK_C_GetObjectSize', 'LUNA_RET_WEIGHT_TOO_LARGE',
           'LUNA_RET_SM_CONTEXT_BUFFER_OVERFLOW',
           'LUNA_RET_PRIVATE_KEY_MUST_BE_SENSITIVE',
           'CK_RC5_MAC_GENERAL_PARAMS_PTR', 'CK_C_DigestUpdate',
           'LUNA_RET_KEY_SIZE_RANGE',
           'LUNA_RET_RSA_SELF_TEST_FAILURE',
           'CK_X9_42_DH1_DERIVE_PARAMS', 'C_GetFunctionList',
           'CK_CA_SetCloningDomain', 'CA_EncodeECParamsFromFile',
           'LUNA_RET_TPV_INVALID', 'LUNA_RET_ECC_HOK_MISSING',
           'CA_LogEraseAll', 'CA_DeactivateMofN',
           'LUNA_RET_RM_POLICY_WRITE_RESTRICTED',
           'CK_C_PerformSelfTest', 'LUNA_RET_CHALLENGE_INVALID',
           'CA_CloneAsTarget', 'CK_CA_Restart',
           'LUNA_RET_UNWRAPPING_KEY_TYPE_INCONSISTENT', 'CK_INFO_PTR',
           'CA_GetModuleList', 'CK_CA_ModifyUsageCount',
           'CA_LogExportSecret', 'CK_BBOOL',
           'CK_CA_EncodeECChar2Params', 'CA_IsMofNRequired',
           'MSG_RTC_TAMPER_2_SIGNAL', 'CK_CA_GetModuleInfo',
           'LUNA_RET_RIPEMD160_SELF_TEST_FAILURE', 'CK_CA_SetTPV',
           'RC_TOKEN_STATE_INVALID', 'RC_KEY_NEEDED', 'C_DecryptInit',
           ...
           'CK_C_DestroyObject', 'LUNA_RET_CB_NO_MEMORY',
           'LUNA_RET_CAST_SELF_TEST_FAILURE',
           'CK_X9_42_DH2_DERIVE_PARAMS',
           'CK_SKIPJACK_PRIVATE_WRAP_PARAMS',
           'CK_X9_42_MQV_DERIVE_PARAMS_PTR', 'Int8',
           'LUNA_RET_DAK_MISSING', 'CK_RC2_CBC_PARAMS',
           'LUNA_RET_CAN_NOT_CREATE_PRIVATE_KEY',
           'CK_X9_42_MQV_DERIVE_PARAMS',
           'CA_GetRollbackFirmwareVersion', 'RC_INVALID_INDEX',
           ...
           'CK_CA_GetTokenStorageInformation', 'CK_C_EncryptUpdate',
           ...
           'MSG_RTC_RECONFIGURING_FAILED', 'CK_DESTROYMUTEX',
           ...
           'CK_CA_GetTokenObjectUID', 'LUNA_RET_CB_ID_INVALID',
           'LUNA_RET_CB_SYNC_ERROR', 'CK_CA_GetUserContainerName',
           'CK_CA_MTKZeroize', 'CK_CA_GetClusterState',
           'CA_GetContainerName', 'CK_AES_CTR_PARAMS',
           'CA_SetContainerSize', 'CK_LKM_TOKEN_ID_S',
           'CA_SetExtendedTPV', 'CK_CA_GetSecureElementMeta',
           'CA_GetUserContainerNumber', 'CK_ECDH2_DERIVE_PARAMS',
           'LUNA_RET_AGAIN', 'CA_InsertMaskedObject',
           ...
           'LUNA_RET_SM_ACCESS_REALLOC_ERROR', 'CKCA_MODULE_INFO_PTR',
           'CA_WriteCommonStore', 'CA_InitializeRemotePEDVector',
           'MSG_RTC_EXTERNAL_TAMPER_LATCHED', 'CK_CA_MTKGetState',
           'LUNA_RET_SO_LOGIN_FAILURE_THRESHOLD', 'CK_CA_SetMofN',
           'LUNA_RET_SELF_TEST_FAILURE',
           'LUNA_RET_CB_HIOS_INPUT_BUFFER_TOO_SMALL',
           'LUNA_RET_HIFN6500_INVALID_PARAMETERS',
           'CA_CloseSecureToken', 'CK_CA_SpRawRead',
           'CK_CA_IsMofNEnabled', 'CK_C_SetAttributeValue',
           'C_GetObjectSize', 'RC_SSL_CIPHER_LIST_ERROR',
           'CK_CA_DismantleRemotePED', 'LUNA_RET_FUNCTION_CANCELED',
           ...
           'CK_CA_ListSecureToken', 'LUNA_RET_CHALLENGE_TYPE_INVALID',
           'C_GenerateRandom', 'CA_GetContainerCapabilitySet',
           'CK_CA_ClonePrivateKey', 'CK_CA_DeleteContainerWithHandle',
           'CK_HA_STATE_PTR', 'CA_GetTunnelSlotNumber',
           'LUNA_RET_RM_ELEMENT_ID_INVALID', 'CA_SetHSMPolicy',
           'CK_WTLS_MASTER_KEY_DERIVE_PARAMS_PTR',
           'CA_SetCloningDomain', 'CK_OBJECT_CLASS_PTR',
           'CK_CA_ChooseSecondarySlot', 'CK_CA_SetHSMPolicies',
           'LUNA_RET_WRAPPED_KEY_LEN_RANGE', 'CA_MOFN_STATUS_PTR',
           'CA_SetLKCV', 'CK_RC2_PARAMS',
