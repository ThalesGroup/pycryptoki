...
CK_CA_CreateLoginChallenge = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_USER_TYPE, CK_ULONG, CK_CHAR_PTR, CK_ULONG_PTR,
                                       CK_CHAR_PTR)
CK_CA_CreateContainerLoginChallenge = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_SLOT_ID, CK_USER_TYPE, CK_ULONG,
...
CK_CA_OpenSessionWithAppID = CFUNCTYPE(CK_RV, CK_SLOT_ID, CK_FLAGS, CK_ULONG, CK_ULONG, CK_VOID_PTR, CK_NOTIFY,
...
CK_CA_CloneObject = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_SESSION_HANDLE, CK_ULONG, CK_OBJECT_HANDLE,
                              CK_OBJECT_HANDLE_PTR)
CK_CA_GenerateCloningKEV = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_BYTE_PTR, CK_ULONG_PTR)
CK_BBOOL = CK_BYTE
CK_CA_CloneAsTargetInit = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG, CK_BBOOL,
                                    CK_BYTE_PTR, CK_ULONG_PTR)
CK_CA_CloneAsSource = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_ULONG, CK_ULONG, CK_BYTE_PTR, CK_ULONG, CK_BBOOL,
                                CK_BYTE_PTR, CK_ULONG_PTR)
CK_CA_CloneAsTarget = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG, CK_ULONG,
                                CK_ULONG, CK_BBOOL, CK_OBJECT_HANDLE_PTR)
CK_CA_SetMofN = CFUNCTYPE(CK_RV, CK_BBOOL)
CK_CA_GenerateMofN = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_ULONG, CA_MOFN_GENERATION_PTR, CK_ULONG, CK_ULONG,
                               CK_VOID_PTR)
CK_CA_GenerateCloneableMofN = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_ULONG, CA_MOFN_GENERATION_PTR, CK_ULONG, CK_ULONG,
                                        CK_VOID_PTR)
CK_CA_ModifyMofN = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_ULONG, CA_MOFN_GENERATION_PTR, CK_ULONG, CK_ULONG,
                             CK_VOID_PTR)
...
CK_CA_SetTokenCertificateSignature = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_ULONG, CK_ULONG, CK_ATTRIBUTE_PTR, CK_ULONG,
...
CK_CA_LoadModule = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR,
                             CK_ULONG, CK_BYTE_PTR, CK_ULONG, CKCA_MODULE_ID_PTR)
CK_CA_LoadEncryptedModule = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_OBJECT_HANDLE, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR,
                                      CK_ULONG, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG, CKCA_MODULE_ID_PTR)
CK_CA_UnloadModule = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CKCA_MODULE_ID)
CK_CA_PerformModuleCall = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CKCA_MODULE_ID, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR,
                                    CK_ULONG, CK_ULONG_PTR)
CK_CA_FirmwareUpdate = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_ULONG, CK_ULONG, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR,
...
CK_CA_GetConfigurationElementDescription = CFUNCTYPE(CK_RV, CK_SLOT_ID, CK_ULONG, CK_ULONG, CK_ULONG, CK_ULONG_PTR,
                                                     CK_ULONG_PTR, CK_ULONG_PTR, CK_CHAR_PTR)
...
CK_CA_GetContainerCapabilitySet = CFUNCTYPE(CK_RV, CK_SLOT_ID, CK_ULONG, CK_ULONG_PTR, CK_ULONG_PTR, CK_ULONG_PTR,
                                            CK_ULONG_PTR)
CK_CA_GetContainerCapabilitySetting = CFUNCTYPE(CK_RV, CK_SLOT_ID, CK_ULONG, CK_ULONG, CK_ULONG_PTR)
CK_CA_GetContainerPolicySet = CFUNCTYPE(CK_RV, CK_SLOT_ID, CK_ULONG, CK_ULONG_PTR, CK_ULONG_PTR, CK_ULONG_PTR,
                                        CK_ULONG_PTR)
...
CK_CA_QueryLicense = CFUNCTYPE(CK_RV, CK_SLOT_ID, CK_ULONG, CK_ULONG, CK_ULONG_PTR, CK_ULONG_PTR, CK_ULONG_PTR,
                               CK_BYTE_PTR)
CK_CA_GetContainerStatus = CFUNCTYPE(CK_RV, CK_SLOT_ID, CK_ULONG, CK_ULONG_PTR, CK_ULONG_PTR, CK_ULONG_PTR,
                                     CK_ULONG_PTR)
...
CK_CA_OpenSecureToken = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_ULONG, CK_ULONG, CK_ULONG, CK_ULONG, CK_ULONG_PTR,
                                  CK_ULONG_PTR, CK_ULONG, CK_CHAR_PTR)
CK_CA_CloseSecureToken = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_ULONG)
CK_CA_ListSecureTokenInit = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_ULONG, CK_ULONG, CK_ULONG_PTR, CK_ULONG_PTR,
                                      CK_BYTE_PTR)
CK_CA_ListSecureTokenUpdate = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_ULONG, CK_ULONG, CK_BYTE_PTR, CK_ULONG)
...
CK_CA_GetSecureElementMeta = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_ULONG, CK_MECHANISM_PTR, CK_ULONG_PTR, CK_ULONG_PTR,
                                       CK_BYTE_PTR, CK_ULONG)
...
CK_CA_HAGetLoginChallenge = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_USER_TYPE, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR,
                                      CK_ULONG_PTR)
CK_CA_HAAnswerLoginChallenge = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_OBJECT_HANDLE, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR,
                                         CK_ULONG_PTR)
...
CK_CA_MultisignValue = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_MECHANISM_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG_PTR,
                                 CK_ULONG_PTR, POINTER(CK_BYTE_PTR), CK_ULONG_PTR, POINTER(CK_BYTE_PTR))
CK_CA_SIMExtract = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_ULONG, CK_OBJECT_HANDLE_PTR, CK_ULONG, CK_ULONG,
                             CKA_SIM_AUTH_FORM, CK_ULONG_PTR, POINTER(CK_BYTE_PTR), CK_BBOOL, CK_ULONG_PTR, CK_BYTE_PTR)
CK_CA_SIMInsert = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_ULONG, CKA_SIM_AUTH_FORM, CK_ULONG_PTR, POINTER(CK_BYTE_PTR),
                            CK_ULONG, CK_BYTE_PTR, CK_ULONG_PTR, CK_OBJECT_HANDLE_PTR)
CK_CA_SIMMultiSign = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_MECHANISM_PTR, CK_ULONG, CKA_SIM_AUTH_FORM, CK_ULONG_PTR,
                               POINTER(CK_BYTE_PTR), CK_ULONG, CK_BYTE_PTR, CK_ULONG, CK_ULONG_PTR,
                               POINTER(CK_BYTE_PTR), CK_ULONG_PTR, POINTER(CK_BYTE_PTR))
...
CK_CA_InvokeServiceSinglePart = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_ULONG, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR,
                                          CK_ULONG_PTR)
CK_CA_EncodeECPrimeParams = CFUNCTYPE(CK_RV, CK_BYTE_PTR, CK_ULONG_PTR, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG,
                                      CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR,
                                      CK_ULONG, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG)
CK_CA_EncodeECChar2Params = CFUNCTYPE(CK_RV, CK_BYTE_PTR, CK_ULONG_PTR, CK_ULONG, CK_ULONG, CK_ULONG, CK_ULONG,
                                      CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR,
                                      CK_ULONG, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG)
...
CK_CA_GetTokenStorageInformation = CFUNCTYPE(CK_RV, CK_SLOT_ID, CK_ULONG_PTR, CK_ULONG_PTR, CK_ULONG_PTR, CK_ULONG_PTR,
                                             CK_ULONG_PTR)
CK_CA_GetContainerStorageInformation = CFUNCTYPE(CK_RV, CK_SLOT_ID, CK_ULONG, CK_ULONG_PTR, CK_ULONG_PTR, CK_ULONG_PTR,
                                                 CK_ULONG_PTR, CK_ULONG_PTR)
CK_CA_SetContainerSize = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_ULONG, CK_ULONG)
CK_CA_CreateContainer = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_ULONG, CK_CHAR_PTR, CK_ULONG, CK_CHAR_PTR, CK_ULONG,
                                  CK_ULONG, CK_ULONG, CK_ULONG, CK_ULONG, CK_ULONG, CK_ULONG_PTR)
...
CK_CA_LogGetConfig = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, POINTER(CK_ULONG), POINTER(CK_ULONG), POINTER(CK_ULONG),
                               POINTER(CK_ULONG), CK_BYTE_PTR)
CK_CA_LogGetStatus = CFUNCTYPE(CK_RV, CK_SLOT_ID, POINTER(CK_ULONG), POINTER(CK_ULONG), POINTER(CK_ULONG),
...
CK_CA_LKMInitiatorChallenge = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_OBJECT_HANDLE, CK_OBJECT_HANDLE, CK_ULONG,
                                        CK_LKM_TOKEN_ID_PTR, CK_LKM_TOKEN_ID_PTR, CK_CHAR_PTR, CK_ULONG_PTR)
CK_CA_LKMReceiverResponse = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_OBJECT_HANDLE, CK_OBJECT_HANDLE, CK_ULONG,
                                      CK_LKM_TOKEN_ID_PTR, CK_CHAR_PTR, CK_ULONG, CK_CHAR_PTR, CK_ULONG_PTR)
CK_CA_LKMInitiatorComplete = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_CHAR_PTR, CK_ULONG, CK_ATTRIBUTE_PTR, CK_ULONG,
                                       CK_ATTRIBUTE_PTR, CK_ULONG, CK_CHAR_PTR, CK_ULONG_PTR, CK_OBJECT_HANDLE_PTR,
                                       CK_OBJECT_HANDLE_PTR)
CK_CA_LKMReceiverComplete = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_CHAR_PTR, CK_ULONG, CK_ATTRIBUTE_PTR, CK_ULONG,
...
CK_CA_GetUnauthTokenInsertionStatus = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_ULONG, POINTER(CK_ULONG),
                                                POINTER(CK_ULONG))
CK_CA_DisableUnauthTokenInsertion = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_ULONG)
CK_CA_STCRegister = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_SLOT_ID, POINTER(CK_CHAR), CK_ULONG, POINTER(CK_CHAR),
                              CK_ULONG, POINTER(CK_CHAR), CK_ULONG)
CK_CA_STCDeregister = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_SLOT_ID, POINTER(CK_CHAR))
CK_CA_STCGetPubKey = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_SLOT_ID, POINTER(CK_CHAR), POINTER(CK_CHAR), CK_ULONG_PTR,
...
CK_CA_STCGetClientInfo = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_SLOT_ID, CK_ULONG, POINTER(CK_CHAR), CK_ULONG_PTR,
                                   CK_ULONG_PTR, POINTER(CK_CHAR), CK_ULONG_PTR, POINTER(CK_CHAR), CK_ULONG_PTR)
CK_CA_STCGetPartPubKey = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_SLOT_ID, POINTER(CK_CHAR), CK_ULONG_PTR,
                                   POINTER(CK_CHAR), CK_ULONG_PTR)
...
CK_CA_STCGetCipherAlgorithm = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_ULONG, CK_BYTE_PTR, CK_ULONG_PTR)
...
CK_CA_STCGetDigestAlgorithm = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_ULONG, CK_BYTE_PTR, CK_ULONG_PTR)
...
CK_CA_PerformSelfTest = CFUNCTYPE(CK_RV, CK_SLOT_ID, CK_ULONG, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG_PTR)
if 'win' in sys.platform:
...
CA_CreateContainerLoginChallenge.argtypes = [CK_SESSION_HANDLE, CK_SLOT_ID, CK_USER_TYPE, CK_ULONG, CK_CHAR_PTR,
...
CA_OpenSessionWithAppID.argtypes = [CK_SLOT_ID, CK_FLAGS, CK_ULONG, CK_ULONG, CK_VOID_PTR, CK_NOTIFY,
                                    CK_SESSION_HANDLE_PTR]
...
CA_CloneAsTargetInit.argtypes = [CK_SESSION_HANDLE, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG, CK_BBOOL, CK_BYTE_PTR,
                                 CK_ULONG_PTR]
CA_CloneAsSource = make_late_binding_function('CA_CloneAsSource')
CA_CloneAsSource.restype = CK_RV
CA_CloneAsSource.argtypes = [CK_SESSION_HANDLE, CK_ULONG, CK_ULONG, CK_BYTE_PTR, CK_ULONG, CK_BBOOL, CK_BYTE_PTR,
                             CK_ULONG_PTR]
CA_CloneAsTarget = make_late_binding_function('CA_CloneAsTarget')
CA_CloneAsTarget.restype = CK_RV
CA_CloneAsTarget.argtypes = [CK_SESSION_HANDLE, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG, CK_ULONG, CK_ULONG,
                             CK_BBOOL, CK_OBJECT_HANDLE_PTR]
...
CA_GenerateCloneableMofN.argtypes = [CK_SESSION_HANDLE, CK_ULONG, CA_MOFN_GENERATION_PTR, CK_ULONG, CK_ULONG,
                                     CK_VOID_PTR]
...
CA_SetTokenCertificateSignature.argtypes = [CK_SESSION_HANDLE, CK_ULONG, CK_ULONG, CK_ATTRIBUTE_PTR, CK_ULONG,
                                            CK_BYTE_PTR, CK_ULONG]
...
CA_LoadModule.argtypes = [CK_SESSION_HANDLE, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG,
...
CA_LoadEncryptedModule.argtypes = [CK_SESSION_HANDLE, CK_OBJECT_HANDLE, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG,
...
CA_PerformModuleCall.argtypes = [CK_SESSION_HANDLE, CKCA_MODULE_ID, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG,
                                 CK_ULONG_PTR]
CA_FirmwareUpdate = make_late_binding_function('CA_FirmwareUpdate')
CA_FirmwareUpdate.restype = CK_RV
CA_FirmwareUpdate.argtypes = [CK_SESSION_HANDLE, CK_ULONG, CK_ULONG, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG,
                              CK_BYTE_PTR]
...
CA_GetConfigurationElementDescription.argtypes = [CK_SLOT_ID, CK_ULONG, CK_ULONG, CK_ULONG, CK_ULONG_PTR, CK_ULONG_PTR,
                                                  CK_ULONG_PTR, CK_CHAR_PTR]
...
CA_GetTokenCapabilities.argtypes = [CK_SLOT_ID, CK_ULONG_PTR, CK_ULONG_PTR, CK_ULONG_PTR, CK_ULONG_PTR]
...
CA_OpenSecureToken.argtypes = [CK_SESSION_HANDLE, CK_ULONG, CK_ULONG, CK_ULONG, CK_ULONG, CK_ULONG_PTR, CK_ULONG_PTR,
...
CA_ListSecureTokenInit.argtypes = [CK_SESSION_HANDLE, CK_ULONG, CK_ULONG, CK_ULONG_PTR, CK_ULONG_PTR, CK_BYTE_PTR]
...
CA_GetSecureElementMeta.argtypes = [CK_SESSION_HANDLE, CK_ULONG, CK_MECHANISM_PTR, CK_ULONG_PTR, CK_ULONG_PTR,
                                    CK_BYTE_PTR, CK_ULONG]
...
CA_HAAnswerLoginChallenge.argtypes = [CK_SESSION_HANDLE, CK_OBJECT_HANDLE, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR,
                                      CK_ULONG_PTR]
...
CA_MultisignValue.argtypes = [CK_SESSION_HANDLE, CK_MECHANISM_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG_PTR, CK_ULONG_PTR,
                              POINTER(CK_BYTE_PTR), CK_ULONG_PTR, POINTER(CK_BYTE_PTR)]
CA_SIMExtract = make_late_binding_function('CA_SIMExtract')
CA_SIMExtract.restype = CK_RV
CA_SIMExtract.argtypes = [CK_SESSION_HANDLE, CK_ULONG, CK_OBJECT_HANDLE_PTR, CK_ULONG, CK_ULONG, CKA_SIM_AUTH_FORM,
                          CK_ULONG_PTR, POINTER(CK_BYTE_PTR), CK_BBOOL, CK_ULONG_PTR, CK_BYTE_PTR]
CA_SIMInsert = make_late_binding_function('CA_SIMInsert')
CA_SIMInsert.restype = CK_RV
CA_SIMInsert.argtypes = [CK_SESSION_HANDLE, CK_ULONG, CKA_SIM_AUTH_FORM, CK_ULONG_PTR, POINTER(CK_BYTE_PTR), CK_ULONG,
...
CA_SIMMultiSign.argtypes = [CK_SESSION_HANDLE, CK_MECHANISM_PTR, CK_ULONG, CKA_SIM_AUTH_FORM, CK_ULONG_PTR,
                            POINTER(CK_BYTE_PTR), CK_ULONG, CK_BYTE_PTR, CK_ULONG, CK_ULONG_PTR, POINTER(CK_BYTE_PTR),
...
CA_EncodeECPrimeParams.argtypes = [CK_BYTE_PTR, CK_ULONG_PTR, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR,
                                   CK_ULONG, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG,
...
CA_EncodeECChar2Params.argtypes = [CK_BYTE_PTR, CK_ULONG_PTR, CK_ULONG, CK_ULONG, CK_ULONG, CK_ULONG, CK_BYTE_PTR,
                                   CK_ULONG, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG,
...
CA_GetTokenStorageInformation.argtypes = [CK_SLOT_ID, CK_ULONG_PTR, CK_ULONG_PTR, CK_ULONG_PTR, CK_ULONG_PTR,
                                          CK_ULONG_PTR]
...
CA_GetContainerStorageInformation.argtypes = [CK_SLOT_ID, CK_ULONG, CK_ULONG_PTR, CK_ULONG_PTR, CK_ULONG_PTR,
                                              CK_ULONG_PTR, CK_ULONG_PTR]
...
CA_CreateContainer.argtypes = [CK_SESSION_HANDLE, CK_ULONG, CK_CHAR_PTR, CK_ULONG, CK_CHAR_PTR, CK_ULONG, CK_ULONG,
                               CK_ULONG, CK_ULONG, CK_ULONG, CK_ULONG, CK_ULONG_PTR]
...
CA_LogGetConfig.argtypes = [CK_SESSION_HANDLE, POINTER(CK_ULONG), POINTER(CK_ULONG), POINTER(CK_ULONG),
                            POINTER(CK_ULONG), CK_BYTE_PTR]
CA_LogGetStatus = make_late_binding_function('CA_LogGetStatus')
CA_LogGetStatus.restype = CK_RV
CA_LogGetStatus.argtypes = [CK_SLOT_ID, POINTER(CK_ULONG), POINTER(CK_ULONG), POINTER(CK_ULONG), POINTER(CK_ULONG),
                            POINTER(CK_ULONG)]
...
CA_LKMInitiatorChallenge.argtypes = [CK_SESSION_HANDLE, CK_OBJECT_HANDLE, CK_OBJECT_HANDLE, CK_ULONG,
                                     CK_LKM_TOKEN_ID_PTR, CK_LKM_TOKEN_ID_PTR, CK_CHAR_PTR, CK_ULONG_PTR]
CA_LKMReceiverResponse = make_late_binding_function('CA_LKMReceiverResponse')
CA_LKMReceiverResponse.restype = CK_RV
CA_LKMReceiverResponse.argtypes = [CK_SESSION_HANDLE, CK_OBJECT_HANDLE, CK_OBJECT_HANDLE, CK_ULONG, CK_LKM_TOKEN_ID_PTR,
                                   CK_CHAR_PTR, CK_ULONG, CK_CHAR_PTR, CK_ULONG_PTR]
CA_LKMInitiatorComplete = make_late_binding_function('CA_LKMInitiatorComplete')
CA_LKMInitiatorComplete.restype = CK_RV
CA_LKMInitiatorComplete.argtypes = [CK_SESSION_HANDLE, CK_CHAR_PTR, CK_ULONG, CK_ATTRIBUTE_PTR, CK_ULONG,
                                    CK_ATTRIBUTE_PTR, CK_ULONG, CK_CHAR_PTR, CK_ULONG_PTR, CK_OBJECT_HANDLE_PTR,
                                    CK_OBJECT_HANDLE_PTR]
CA_LKMReceiverComplete = make_late_binding_function('CA_LKMReceiverComplete')
CA_LKMReceiverComplete.restype = CK_RV
CA_LKMReceiverComplete.argtypes = [CK_SESSION_HANDLE, CK_CHAR_PTR, CK_ULONG, CK_ATTRIBUTE_PTR, CK_ULONG,
                                   CK_ATTRIBUTE_PTR, CK_ULONG, CK_OBJECT_HANDLE_PTR, CK_OBJECT_HANDLE_PTR]
...
CA_GetUnauthTokenInsertionStatus.argtypes = [CK_SESSION_HANDLE, CK_ULONG, POINTER(CK_ULONG), POINTER(CK_ULONG)]
...
CA_STCRegister.argtypes = [CK_SESSION_HANDLE, CK_SLOT_ID, POINTER(CK_CHAR), CK_ULONG, POINTER(CK_CHAR), CK_ULONG,
                           POINTER(CK_CHAR), CK_ULONG]
...
CA_STCGetPubKey.argtypes = [CK_SESSION_HANDLE, CK_SLOT_ID, POINTER(CK_CHAR), POINTER(CK_CHAR), CK_ULONG_PTR,
                            POINTER(CK_CHAR), CK_ULONG_PTR]
...
CA_STCGetClientInfo.argtypes = [CK_SESSION_HANDLE, CK_SLOT_ID, CK_ULONG, POINTER(CK_CHAR), CK_ULONG_PTR, CK_ULONG_PTR,
...
CA_STCGetPartPubKey.argtypes = [CK_SESSION_HANDLE, CK_SLOT_ID, POINTER(CK_CHAR), CK_ULONG_PTR, POINTER(CK_CHAR),
                                CK_ULONG_PTR]
CA_STCGetAdminPubKey = make_late_binding_function('CA_STCGetAdminPubKey')
CA_STCGetAdminPubKey.restype = CK_RV
CA_STCGetAdminPubKey.argtypes = [CK_SLOT_ID, POINTER(CK_CHAR), CK_ULONG_PTR, POINTER(CK_CHAR), CK_ULONG_PTR]
...
CA_PerformSelfTest.argtypes = [CK_SLOT_ID, CK_ULONG, CK_BYTE_PTR, CK_ULONG, CK_BYTE_PTR, CK_ULONG_PTR]
...
CK_C_GenerateKey = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_MECHANISM_PTR, CK_ATTRIBUTE_PTR, CK_ULONG,
                             CK_OBJECT_HANDLE_PTR)
CK_C_GenerateKeyPair = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_MECHANISM_PTR, CK_ATTRIBUTE_PTR, CK_ULONG,
                                 CK_ATTRIBUTE_PTR, CK_ULONG, CK_OBJECT_HANDLE_PTR, CK_OBJECT_HANDLE_PTR)
CK_C_WrapKey = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_MECHANISM_PTR, CK_OBJECT_HANDLE, CK_OBJECT_HANDLE, CK_BYTE_PTR,
                         CK_ULONG_PTR)
CK_C_UnwrapKey = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_MECHANISM_PTR, CK_OBJECT_HANDLE, CK_BYTE_PTR, CK_ULONG,
                           CK_ATTRIBUTE_PTR, CK_ULONG, CK_OBJECT_HANDLE_PTR)
CK_C_DeriveKey = CFUNCTYPE(CK_RV, CK_SESSION_HANDLE, CK_MECHANISM_PTR, CK_OBJECT_HANDLE, CK_ATTRIBUTE_PTR, CK_ULONG,
                           CK_OBJECT_HANDLE_PTR)
...
C_GenerateKeyPair.argtypes = [CK_SESSION_HANDLE, CK_MECHANISM_PTR, CK_ATTRIBUTE_PTR, CK_ULONG, CK_ATTRIBUTE_PTR,
                              CK_ULONG, CK_OBJECT_HANDLE_PTR, CK_OBJECT_HANDLE_PTR]
C_WrapKey = make_late_binding_function('C_WrapKey')
C_WrapKey.restype = CK_RV
C_WrapKey.argtypes = [CK_SESSION_HANDLE, CK_MECHANISM_PTR, CK_OBJECT_HANDLE, CK_OBJECT_HANDLE, CK_BYTE_PTR,
                      CK_ULONG_PTR]
...
C_DeriveKey.argtypes = [CK_SESSION_HANDLE, CK_MECHANISM_PTR, CK_OBJECT_HANDLE, CK_ATTRIBUTE_PTR, CK_ULONG,
                        CK_OBJECT_HANDLE_PTR]
...
__all__ = ['CA_InvokeService', 'LUNA_RET_PED_UNSUPPORTED_PROTOCOL',
           ...
           'LUNA_RET_MD5_SELF_TEST_FAILURE', 'LUNA_RET_LOG_BAD_TIME',
           ...
           'C_SignInit', 'LUNA_RET_MISSING_NUMBER_OF_VECTORS',
           ...
           'LUNA_RET_SM_SESSION_REALLOC_ERROR', 'CA_MOFN_ACTIVATION',
           ...
           'CK_DES_CTR_PARAMS', 'CA_GetClusterState', 'CK_C_Verify',
           'CK_CA_STCGetCipherAlgorithm', 'CA_STCGetMaxSessions',
           'CK_OBJECT_HANDLE', 'LUNA_RET_TOKEN_LOCKED_OUT',
           'CK_MAC_GENERAL_PARAMS', 'CK_C_VerifyUpdate',
           'CK_CA_WriteCommonStore', 'CA_GetPedId', 'CA_Insert',
           ...
           'LUNA_RET_TOO_MANY_VECTORS_PROVIDED', 'CK_C_DigestFinal',
           'CA_InitIndirectPIN', 'LUNA_RET_PED_DEK_INVALID',
           ...
           'eInitMsgs', 'LUNA_RET_COUNTER_WRAPAROUND',
           ...
           'C_SignEncryptUpdate', 'RC_SHUTTING_DOWN',
           'CK_MECHANISM_TYPE_PTR', 'MSG_RTC_CANT_GET_TAMPER_TIMER',
           ...
           'CK_CA_TokenZeroize', 'CK_EC_KDF_TYPE', 'CKCA_MODULE_ID',
           'CA_LogVerify', 'LUNA_RET_CCM_CERT_INVALID',
           ...
           'CK_RC5_MAC_GENERAL_PARAMS_PTR', 'CK_CA_ClonePrivateKey',
           ...
           'CA_STCGetKeyLifeTime', 'CK_RC2_MAC_GENERAL_PARAMS',
           'CK_SESSION_HANDLE', 'LUNA_RET_KEY_INDIGESTIBLE',
           'CK_SLOT_INFO', 'CA_STCGetDigestID',
           ...
           'CK_C_Logout', 'CA_HAGetLoginChallenge', 'CA_SetRDK',
           ...
           'CK_CA_GetFunctionList', 'CK_CA_CloneAsTarget',
           'CK_CA_HALogin', 'CA_CloneAsSource',
           ...
           'RC_UNEXPECTED', 'CA_InvokeServiceFinal',
           ...
           'LUNA_RET_CB_REMOTE_ABORT', 'RC_BUFFER_TOO_SMALL',
           ...
           'LUNA_RET_CB_HIOS_ID_INVALID', 'CA_CloneMofN',
           'RC_STC_CLIENT_HANDLE_INVALID', 'LUNA_RET_PE1746_ERROR',
           'CK_CA_GenerateMofN', 'CK_CA_GetPrimarySlot', 'Int64',
           ...
           'LUNA_RET_STC_NOT_ENABLED', 'LUNA_RET_ROOT_CERT_MISSING',
           'CA_DeleteContainer', 'LUNA_RET_CHALLENGE_NOT_REQUIRED',
           ...
           'C_DecryptFinal', 'Byte', 'CK_CA_CloneAsSource',
           ...
           'CK_CA_SetMofN', 'CA_TimeSync', 'CA_LKMInitiatorChallenge',
           'CA_InitializeRemotePEDVector', 'HalfWord',
           ...
           'C_GenerateKey', 'RC_SSL_LOAD_SERVER_PRIVATE_KEY_ERROR',
           ...
           'CK_X9_42_DH2_DERIVE_PARAMS_PTR', 'CA_InitRolePIN',
           ...
           'CK_CA_STCSetDigestAlgorithm', 'CA_Restart', 'UInt64',
           'CK_C_Sign', 'CK_CA_ReadCommonStore',
           ...
           'RC_STC_SECOND_PHASE_KDF_ERROR', 'LUNA_RET_RM_NO_MEMORY',
           'CK_CA_SetKCV', 'CK_OBJECT_HANDLE_PTR',
           'CA_LogExportSecret', 'CK_CA_InvokeServiceFinal',
           ...
           'CK_WTLS_KEY_MAT_PARAMS_PTR', 'LUNA_RET_CCM_UNREMOVABLE',
           ...
           'LUNA_RET_SM_OTHER_USER_LOGGED_IN', 'CK_CA_GetTokenStatus',
           'CA_GetContainerCapabilitySetting',
           'RC_SSL_WANT_X509_LOOKUP_ERROR', 'RC_SOCKET_WOULDBLOCK',
           'CA_InvokeServiceAsynch', 'CK_C_GetInfo',
           'CK_C_FindObjectsFinal', 'CK_CA_SetApplicationID',
           'CK_AES_CBC_ENCRYPT_DATA_PARAMS',
           'CK_C_DecryptVerifyUpdate', 'CK_CA_DestroyMultipleObjects',
           ...
           'LUNA_RET_CHALLENGE_REQUIRES_PED', 'RC_GROUP_NAME_INVALID',
           ...
           'LUNA_RET_MM_FATAL_ERROR', 'C_GetFunctionList',
           ...
           'RC_REMOTE_SIDE_DISCONNECTED', 'RC_SSL_CIPHER_LIST_ERROR',
           'CK_CA_DismantleRemotePED', 'LUNA_RET_INVALID_FUF_VERSION',
           ...
           'CA_GetMofNStatus', 'LUNA_RET_SIM_AUTHORIZATION_FAILED',
           ...
           'C_DecryptDigestUpdate', 'CK_AES_GCM_PARAMS',
           'CK_HA_STATE_PTR', 'CA_LogGetConfig',
           'LUNA_RET_HIFN_MAC_HEADER_COUNT_INVALID',
           'CA_SetHSMPolicies', 'LUNA_RET_KCV_PARAMETER_MISSING',
           ...
           'CK_CA_GetExtendedTPV', 'CK_CA_SetHSMPolicy',
           ...
           'CA_DisableUnauthTokenInsertion', 'CK_C_FindObjectsInit',
           ...
           'CK_RC5_CBC_PARAMS', 'CA_InvokeServiceSinglePart',
           ...
           'C_GetMechanismList', 'LUNA_RET_HIFN_MAC_SOURCE_NOT_ZERO',
           ...
           'CK_OTP_PARAMS_PTR', 'LUNA_RET_RSA_SELF_TEST_FAILURE',
           'CK_CA_SetExtendedTPV', 'CA_STCGetCurrentKeyLife',
           ...
           'MSG_RTC_ZEROIZED_ON_POWER_LOSS', 'CA_STCGetPartPubKey',
           'C_DestroyObject', 'LUNA_RET_TOO_MANY_CONTAINERS',
           ...
           'RC_PARTITION_LOCKED', 'CA_STCSetKeyLifeTime',
           ...
           'LUNA_RET_SEED_SELF_TEST_FAILURE', 'CK_TOKEN_INFO_PTR',
           ...
           'CK_CA_STCGetPartPubKey', 'RC_DER_CLASS_INVALID',
           'LUNA_RET_TPV_INVALID', 'CA_DeactivateMofN',
           'CK_ECDH1_DERIVE_PARAMS_PTR', 'LUNA_RET_VECTOR_TOO_SMALL',
           'CK_C_Encrypt', 'MSG_RTC_TAMPER_2_SIGNAL',
           'CA_CloseApplicationIDForContainer', 'C_DecryptUpdate',
           'Int8', 'LUNA_RET_HIFN_INVALID_ENCRYPT_MODE',
           'CK_C_DestroyObject', 'CK_CA_STCGetKeyLifeTime',
           ...
           'LUNA_RET_CHALLENGE_TYPE_INVALID', 'C_GenerateRandom',
