...
ret_vals_dictionary = {
    ...
    CKR_PED_UNSUPPORTED: "CKR_PED_UNSUPPORTED",
    CKR_PED_ERROR: "CKR_PED_ERROR",
    CKR_ACCESS_ID_CONFLICT: "CKR_ACCESS_ID_CONFLICT",
    CKR_KEY_INVALID_FOR_HA_LOGIN: "CKR_KEY_INVALID_FOR_HA_LOGIN",
    CKR_KEY_EXTRACTABLE: "CKR_KEY_EXTRACTABLE",
    CKR_AUTH_DATA_NOT_ALLOWED: "CKR_AUTH_DATA_NOT_ALLOWED",
    CKR_ASSIGNED_KEY_NOT_ALLOWED: "CKR_ASSIGNED_KEY_NOT_ALLOWED",
    CKR_INTEGER_OVERFLOW: "CKR_INTEGER_OVERFLOW",
    ...
    CKR_ASSIGNED_KEY_FAILED_ATTRIBUTE_DEPENDENCIES: "CKR_ASSIGNED_KEY_FAILED_ATTRIBUTE_DEPENDENCIES",
    ...
    CKR_BUSY: "CKR_BUSY",
    CKR_ECC_UNKNOWN_CURVE: "CKR_ECC_UNKNOWN_CURVE",
    CKR_ECC_CURVE_NOT_ALLOWED: "CKR_ECC_CURVE_NOT_ALLOWED",
}
...
MECH_NAME_LOOKUP = {
    ...
    (CKM_VENDOR_DEFINED + 0x208): "CKM_CPV4_EXTRACT",
    (CKM_VENDOR_DEFINED + 0x209): "CKM_CPV4_INSERT",
    ...
    (CKM_VENDOR_DEFINED + 0xC01): "CKM_EC_EDWARDS_KEY_PAIR_GEN",
    (CKM_VENDOR_DEFINED + 0xC02): "CKM_EDDSA_NACL",
    (CKM_VENDOR_DEFINED + 0xC03): "CKM_EDDSA",
    (CKM_VENDOR_DEFINED + 0xC04): "CKM_SHA1_EDDSA_NACL",
    (CKM_VENDOR_DEFINED + 0xC05): "CKM_SHA224_EDDSA_NACL",
    (CKM_VENDOR_DEFINED + 0xC06): "CKM_SHA256_EDDSA_NACL",
    (CKM_VENDOR_DEFINED + 0xC07): "CKM_SHA384_EDDSA_NACL",
    (CKM_VENDOR_DEFINED + 0xC08): "CKM_SHA512_EDDSA_NACL",
    (CKM_VENDOR_DEFINED + 0xC09): "CKM_SHA1_EDDSA",
    (CKM_VENDOR_DEFINED + 0xC0A): "CKM_SHA224_EDDSA",
    (CKM_VENDOR_DEFINED + 0xC0B): "CKM_SHA256_EDDSA",
    (CKM_VENDOR_DEFINED + 0xC0C): "CKM_SHA384_EDDSA",
    (CKM_VENDOR_DEFINED + 0xC0D): "CKM_SHA512_EDDSA",
    ...
    (CKM_VENDOR_DEFINED + 0xF00): "CKM_SHAKE_128",
    (CKM_VENDOR_DEFINED + 0xF01): "CKM_SHAKE_256",
    (CKM_VENDOR_DEFINED + 0xF08): "CKM_KECCAK_224",
    (CKM_VENDOR_DEFINED + 0xF09): "CKM_KECCAK_256",
    (CKM_VENDOR_DEFINED + 0xF0A): "CKM_KECCAK_384",
    (CKM_VENDOR_DEFINED + 0xF0B): "CKM_KECCAK_512",
    ...
    0x00000397: "CKM_SHA3_256_KEY_DERIVE",
    0x00000398: "CKM_SHA3_224_KEY_DERIVE",
    0x00000399: "CKM_SHA3_384_KEY_DERIVE",
    0x0000039A: "CKM_SHA3_512_KEY_DERIVE",
    0x0000039B: "CKM_SHAKE_128_KEY_DERIVE",
    0x0000039C: "CKM_SHAKE_256_KEY_DERIVE",
    (CKM_VENDOR_DEFINED + 0xF20): "CKM_SHA3_224_EDDSA",
    (CKM_VENDOR_DEFINED + 0xF21): "CKM_SHA3_256_EDDSA",
    (CKM_VENDOR_DEFINED + 0xF22): "CKM_SHA3_384_EDDSA",
    (CKM_VENDOR_DEFINED + 0xF23): "CKM_SHA3_512_EDDSA",
}
