...
def ca_generatemofn(h_session, m_value, vector_value, vector_count, is_secure_port_used):
    ...
    ret = CA_GenerateMofN(h_session, m_value, vectors, vector_count, is_secure_port_used, reserved)
    return ret
