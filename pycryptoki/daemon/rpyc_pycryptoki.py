...
class PycryptokiService(rpyc.SlaveService):
    ...
    exposed_ca_get_cv_firmware_version = staticmethod(ca_get_cv_firmware_version)
    exposed_ca_get_cv_firmware_version_ex = staticmethod(ca_get_cv_firmware_version_ex)
