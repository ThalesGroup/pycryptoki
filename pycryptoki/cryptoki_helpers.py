...
def _search_for_dll_in_chrystoki_conf(conf_path, chrystoki_conf_text):
    ...
    @return: The path to the chrystoki DLL
    '''
    if 'win' in sys.platform:
        ...
        if len(chrystoki2_segments) > 1:
            ...
            raise Exception("Found " + len(chrystoki2_segments) + "Chrystoki2 sections in the config file: " + str(conf_path))
