...
from pycryptoki.default_templates import CKM_DES_KEY_GEN_TEMP, \
    ...
    CKM_RC4_KEY_GEN_TEMP, CKM_RC5_KEY_GEN_TEMP, CKM_SSL3_PRE_MASTER_KEY_GEN_TEMP, \
    CKM_AES_KEY_GEN_TEMP, CKM_SEED_KEY_GEN_TEMP, CKM_DSA_PARAMETER_GEN_TEMP, \
    CKM_KCDSA_PARAMETER_GEN_TEMP, CKM_ARIA_KEY_GEN_TEMP, \
    CKM_DH_PKCS_PARAMETER_GEN_TEMP, CKM_RSA_PKCS_KEY_PAIR_GEN_PUBTEMP, \
    ...
    CKM_RSA_X9_31_KEY_PAIR_GEN_PRIVTEMP, CKM_X9_42_DH_KEY_PAIR_GEN_PUBTEMP, \
    CKM_X9_42_DH_KEY_PAIR_GEN_PRIVTEMP, curve_list
...
from pycryptoki.defines import CKU_USER, CKM_DES_KEY_GEN, CKR_OK, \
    ...
    CKM_RC5_KEY_GEN, CKM_SSL3_PRE_MASTER_KEY_GEN, CKM_AES_KEY_GEN, CKM_SEED_KEY_GEN, \
    CKM_DSA_PARAMETER_GEN, CKM_KCDSA_PARAMETER_GEN, CKM_ARIA_KEY_GEN, \
    CKM_DH_PKCS_PARAMETER_GEN, CKM_RSA_PKCS_KEY_PAIR_GEN, CKM_DSA_KEY_PAIR_GEN, \
    CKM_DH_PKCS_KEY_PAIR_GEN, CKM_ECDSA_KEY_PAIR_GEN, CKM_KCDSA_KEY_PAIR_GEN, \
    CKM_RSA_X9_31_KEY_PAIR_GEN, CKM_X9_42_DH_KEY_PAIR_GEN, \
    CKM_CONCATENATE_BASE_AND_KEY, CKA_ECDSA_PARAMS
